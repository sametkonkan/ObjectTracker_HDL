-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\ObjectTrackerHDL\calcMean_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: calcMean_block
-- Source Path: ObjectTrackerHDL/ObjectTrackerHDL/Preprocess/PrevPreprocess/Image Statistics/calcMean
-- Hierarchy Level: 4
-- Model version: 3.7
-- 
-- -------------------------------------------------------------
...
ARCHITECTURE rtl OF calcMean_block IS

  -- Component Declarations
  COMPONENT dataReadFSM_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          hStart                          :   IN    std_logic;
  ...
  COMPONENT accumulatorBank_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(7 DOWNTO 0);  -- ufix8
  ...
  COMPONENT accumulatorBankVar_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT Normalization_Var_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          lvlOneCount                     :   IN    std_logic_vector(5 DOWNTO 0);  -- ufix6
  ...
  FOR ALL : dataReadFSM_block
    USE ENTITY work.dataReadFSM_block(rtl);

  FOR ALL : counterBank_block
    USE ENTITY work.counterBank_block(rtl);

  FOR ALL : dataWriteFSM_block
    USE ENTITY work.dataWriteFSM_block(rtl);

  FOR ALL : accumulatorBank_block
    USE ENTITY work.accumulatorBank_block(rtl);

  FOR ALL : Normalization_block
    USE ENTITY work.Normalization_block(rtl);

  FOR ALL : accumulatorBankVar_block
    USE ENTITY work.accumulatorBankVar_block(rtl);

  FOR ALL : Normalization_Var_block
    USE ENTITY work.Normalization_Var_block(rtl);
...
BEGIN
  u_dataReadFSM : dataReadFSM_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              hStart => hStartIn,
  ...
  u_counterBank : counterBank_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_dataWriteFSM : dataWriteFSM_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              vEnd => vEndOut,
  ...
  u_accumulatorBank : accumulatorBank_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              dataIn => dataIn,  -- ufix8
  ...
  u_normalization : Normalization_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              lvlOneCount => lvlOneCount,  -- ufix6
  ...
  u_accumulatorBankVar : accumulatorBankVar_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_normalizationVar : Normalization_Var_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              lvlOneCount => lvlOneCount,  -- ufix6
