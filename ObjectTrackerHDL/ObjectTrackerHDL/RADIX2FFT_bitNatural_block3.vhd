-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\ObjectTrackerHDL\RADIX2FFT_bitNatural_block3.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: RADIX2FFT_bitNatural_block3
-- Source Path: ObjectTrackerHDL/ObjectTrackerHDL/Track/2-DCorrelation/Prev2-DFFT/ColumnFFT/RADIX2FFT_bitNatural
-- Hierarchy Level: 5
-- Model version: 3.7
-- 
-- -------------------------------------------------------------
...
ENTITY RADIX2FFT_bitNatural_block3 IS
...
END RADIX2FFT_bitNatural_block3;


ARCHITECTURE rtl OF RADIX2FFT_bitNatural_block3 IS
  ...
  SIGNAL memOut_im                        : std_logic_vector(34 DOWNTO 0);  -- ufix35
  SIGNAL memOut_im_signed                 : signed(34 DOWNTO 0);  -- sfix35_En16
  SIGNAL memOut_re                        : std_logic_vector(34 DOWNTO 0);  -- ufix35
  SIGNAL memOut_re_signed                 : signed(34 DOWNTO 0);  -- sfix35_En16
  ...
  SIGNAL rdStateMachineBitNatural_doutReReg : signed(34 DOWNTO 0);  -- sfix35
  SIGNAL rdStateMachineBitNatural_doutImReg : signed(34 DOWNTO 0);  -- sfix35
  ...
  SIGNAL rdStateMachineBitNatural_doutReReg_next : signed(34 DOWNTO 0);  -- sfix35_En16
  SIGNAL rdStateMachineBitNatural_doutImReg_next : signed(34 DOWNTO 0);  -- sfix35_En16
  ...
  SIGNAL dout_re1_tmp                     : signed(34 DOWNTO 0);  -- sfix35_En16
  SIGNAL dout_im1_tmp                     : signed(34 DOWNTO 0);  -- sfix35_En16
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      ...
      rdStateMachineBitNatural_doutReReg <= to_signed(0, 35);
      rdStateMachineBitNatural_doutImReg <= to_signed(0, 35);
