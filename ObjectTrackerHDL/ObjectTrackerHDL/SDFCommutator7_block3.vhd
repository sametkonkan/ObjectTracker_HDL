-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\ObjectTrackerHDL\SDFCommutator7_block3.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SDFCommutator7_block3
-- Source Path: ObjectTrackerHDL/ObjectTrackerHDL/Track/2-DCorrelation/Prev2-DFFT/ColumnFFT/RADIX22FFT_SDF1_7/SDFCommutator7
-- Hierarchy Level: 6
-- Model version: 3.7
-- 
-- -------------------------------------------------------------
...
ENTITY SDFCommutator7_block3 IS
...
END SDFCommutator7_block3;


ARCHITECTURE rtl OF SDFCommutator7_block3 IS
  ...
  -- Signals
  SIGNAL xf_re_signed                     : signed(34 DOWNTO 0);  -- sfix35_En16
  SIGNAL xf_im_signed                     : signed(34 DOWNTO 0);  -- sfix35_En16
  SIGNAL dinXTwdlf_re_signed              : signed(34 DOWNTO 0);  -- sfix35_En16
  SIGNAL dinXTwdlf_im_signed              : signed(34 DOWNTO 0);  -- sfix35_En16
  SIGNAL btf1_re_signed                   : signed(34 DOWNTO 0);  -- sfix35_En16
  SIGNAL btf1_im_signed                   : signed(34 DOWNTO 0);  -- sfix35_En16
  SIGNAL btf2_re_signed                   : signed(34 DOWNTO 0);  -- sfix35_En16
  SIGNAL btf2_im_signed                   : signed(34 DOWNTO 0);  -- sfix35_En16
  ...
  SIGNAL SDFCummutator_btf1_re_dly        : signed(34 DOWNTO 0);  -- sfix35
  SIGNAL SDFCummutator_btf1_im_dly        : signed(34 DOWNTO 0);  -- sfix35
  SIGNAL SDFCummutator_btf1_vld_dly       : std_logic;
  SIGNAL SDFCummutator_out_re_next        : signed(34 DOWNTO 0);  -- sfix35_En16
  SIGNAL SDFCummutator_out_im_next        : signed(34 DOWNTO 0);  -- sfix35_En16
  ...
  SIGNAL SDFCummutator_wrData_re_reg_next : signed(34 DOWNTO 0);  -- sfix35_En16
  SIGNAL SDFCummutator_wrData_im_reg_next : signed(34 DOWNTO 0);  -- sfix35_En16
  SIGNAL SDFCummutator_wrEnb_reg_next     : std_logic;
  SIGNAL SDFCummutator_wrXData_re_reg_next : signed(34 DOWNTO 0);  -- sfix35_En16
  SIGNAL SDFCummutator_wrXData_im_reg_next : signed(34 DOWNTO 0);  -- sfix35_En16
  ...
  SIGNAL SDFCummutator_btf1_re_dly_next   : signed(34 DOWNTO 0);  -- sfix35_En16
  SIGNAL SDFCummutator_btf1_im_dly_next   : signed(34 DOWNTO 0);  -- sfix35_En16
  SIGNAL SDFCummutator_btf1_vld_dly_next  : std_logic;
  SIGNAL wrData_re_tmp                    : signed(34 DOWNTO 0);  -- sfix35_En16
  SIGNAL wrData_im_tmp                    : signed(34 DOWNTO 0);  -- sfix35_En16
  SIGNAL xData_re                         : signed(34 DOWNTO 0);  -- sfix35_En16
  SIGNAL xData_im                         : signed(34 DOWNTO 0);  -- sfix35_En16
  ...
  SIGNAL dout0_re                         : signed(34 DOWNTO 0);  -- sfix35_En16
  SIGNAL dout0_im                         : signed(34 DOWNTO 0);  -- sfix35_En16
  SIGNAL dout0_vld                        : std_logic;
  SIGNAL xX_re                            : std_logic_vector(34 DOWNTO 0);  -- ufix35
  SIGNAL xX_re_signed                     : signed(34 DOWNTO 0);  -- sfix35_En16
  SIGNAL xX_im                            : std_logic_vector(34 DOWNTO 0);  -- ufix35
  SIGNAL xX_im_signed                     : signed(34 DOWNTO 0);  -- sfix35_En16
  ...
  SIGNAL SDFOutmux_btf2Pipe_re_next       : signed(34 DOWNTO 0);  -- sfix35_En16
  SIGNAL SDFOutmux_btf2Pipe_im_next       : signed(34 DOWNTO 0);  -- sfix35_En16
  SIGNAL SDFOutmux_btfPipe_vld_next       : std_logic;
  SIGNAL dout_7_re_tmp                    : signed(34 DOWNTO 0);  -- sfix35_En16
  SIGNAL dout_7_im_tmp                    : signed(34 DOWNTO 0);  -- sfix35_En16

BEGIN
  u_dataXMEM_re_0_7 : SimpleDualPortRAM_generic_block
  ...
  u_dataXMEM_im_0_7 : SimpleDualPortRAM_generic_block
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 35
                 )
    PORT MAP( clk => clk,
  ...
  BEGIN
    IF reset = '1' THEN
      ...
      SDFCummutator_btf1_re_dly <= to_signed(0, 35);
      SDFCummutator_btf1_im_dly <= to_signed(0, 35);
