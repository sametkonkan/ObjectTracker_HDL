-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\ObjectTrackerHDL\Image_Statistics_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Image_Statistics_block
-- Source Path: ObjectTrackerHDL/ObjectTrackerHDL/Preprocess/PrevPreprocess/Image Statistics
-- Hierarchy Level: 3
-- Model version: 3.7
-- 
-- Image Statistics
...
ENTITY Image_Statistics_block IS
...
END Image_Statistics_block;


ARCHITECTURE rtl OF Image_Statistics_block IS

  -- Component Declarations
  COMPONENT calcMean_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : calcMean_block
    USE ENTITY work.calcMean_block(rtl);

  FOR ALL : SQRTBitSet_block
    USE ENTITY work.SQRTBitSet_block(rtl);
