-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\ObjectTrackerHDL\RowFFT_block.vhd
...
-- 
-- Module: RowFFT_block
-- Source Path: ObjectTrackerHDL/ObjectTrackerHDL/Track/2-DCorrelation/Prev2-DFFT/RowFFT
-- Hierarchy Level: 4
-- Model version: 3.7
-- 
-- FFT
...
ARCHITECTURE rtl OF RowFFT_block IS

  -- Component Declarations
  COMPONENT RADIX22FFT_CTRL1_1_block9
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT RADIX22FFT_SDF1_1_block4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT RADIX22FFT_CTRL1_2_block4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT RADIX22FFT_SDF2_2_block4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT RADIX22FFT_CTRL1_3_block4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT RADIX22FFT_SDF1_3_block4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT RADIX22FFT_CTRL1_4_block4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT RADIX22FFT_SDF2_4_block4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT RADIX22FFT_CTRL1_5_block4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT RADIX22FFT_SDF1_5_block4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT RADIX22FFT_CTRL1_6_block4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT RADIX22FFT_SDF2_6_block4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT TWDLROM_7_1_block4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dout_6_1_vld                    :   IN    std_logic;
          twdl_7_re                       :   OUT   std_logic_vector(31 DOWNTO 0);  -- sfix32_En30
          twdl_7_im                       :   OUT   std_logic_vector(31 DOWNTO 0)  -- sfix32_En30
          );
  END COMPONENT;

  COMPONENT RADIX22FFT_CTRL1_1_block10
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT RADIX22FFT_SDF1_7_block4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT RADIX2FFT_bitNatural_block4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dout_7_re                       :   IN    std_logic_vector(38 DOWNTO 0);  -- sfix39_En28
          dout_7_im                       :   IN    std_logic_vector(38 DOWNTO 0);  -- sfix39_En28
          dout_7_vld                      :   IN    std_logic;
          dout_re1                        :   OUT   std_logic_vector(38 DOWNTO 0);  -- sfix39_En28
          dout_im1                        :   OUT   std_logic_vector(38 DOWNTO 0);  -- sfix39_En28
          dout_vld1                       :   OUT   std_logic
          );
  END COMPONENT;

  -- Component Configuration Statements
  FOR ALL : RADIX22FFT_CTRL1_1_block9
    USE ENTITY work.RADIX22FFT_CTRL1_1_block9(rtl);

  FOR ALL : RADIX22FFT_SDF1_1_block4
    USE ENTITY work.RADIX22FFT_SDF1_1_block4(rtl);

  FOR ALL : RADIX22FFT_CTRL1_2_block4
    USE ENTITY work.RADIX22FFT_CTRL1_2_block4(rtl);

  FOR ALL : RADIX22FFT_SDF2_2_block4
    USE ENTITY work.RADIX22FFT_SDF2_2_block4(rtl);

  FOR ALL : TWDLROM_3_1_block4
    USE ENTITY work.TWDLROM_3_1_block4(rtl);

  FOR ALL : RADIX22FFT_CTRL1_3_block4
    USE ENTITY work.RADIX22FFT_CTRL1_3_block4(rtl);

  FOR ALL : RADIX22FFT_SDF1_3_block4
    USE ENTITY work.RADIX22FFT_SDF1_3_block4(rtl);

  FOR ALL : RADIX22FFT_CTRL1_4_block4
    USE ENTITY work.RADIX22FFT_CTRL1_4_block4(rtl);

  FOR ALL : RADIX22FFT_SDF2_4_block4
    USE ENTITY work.RADIX22FFT_SDF2_4_block4(rtl);

  FOR ALL : TWDLROM_5_1_block4
    USE ENTITY work.TWDLROM_5_1_block4(rtl);

  FOR ALL : RADIX22FFT_CTRL1_5_block4
    USE ENTITY work.RADIX22FFT_CTRL1_5_block4(rtl);

  FOR ALL : RADIX22FFT_SDF1_5_block4
    USE ENTITY work.RADIX22FFT_SDF1_5_block4(rtl);

  FOR ALL : RADIX22FFT_CTRL1_6_block4
    USE ENTITY work.RADIX22FFT_CTRL1_6_block4(rtl);

  FOR ALL : RADIX22FFT_SDF2_6_block4
    USE ENTITY work.RADIX22FFT_SDF2_6_block4(rtl);

  FOR ALL : TWDLROM_7_1_block4
    USE ENTITY work.TWDLROM_7_1_block4(rtl);

  FOR ALL : RADIX22FFT_CTRL1_1_block10
    USE ENTITY work.RADIX22FFT_CTRL1_1_block10(rtl);

  FOR ALL : RADIX22FFT_SDF1_7_block4
    USE ENTITY work.RADIX22FFT_SDF1_7_block4(rtl);

  FOR ALL : RADIX2FFT_bitNatural_block4
    USE ENTITY work.RADIX2FFT_bitNatural_block4(rtl);
  ...
  SIGNAL din_7_re_dly                     : signed(37 DOWNTO 0);  -- sfix38_En28
  SIGNAL intdelay_reg_10                  : vector_of_signed38(0 TO 2);  -- sfix38 [3]
  SIGNAL din_7_im_dly                     : signed(37 DOWNTO 0);  -- sfix38_En28
  SIGNAL intdelay_reg_11                  : std_logic_vector(2 DOWNTO 0);  -- ufix1 [3]
  SIGNAL din_7_vld_dly                    : std_logic;
  SIGNAL twdl_7_re                        : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL twdl_7_im                        : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL dout_7_re                        : std_logic_vector(38 DOWNTO 0);  -- ufix39
  SIGNAL dout_7_im                        : std_logic_vector(38 DOWNTO 0);  -- ufix39
  SIGNAL dout_7_vld                       : std_logic;
  SIGNAL dout_re1                         : std_logic_vector(38 DOWNTO 0);  -- ufix39
  SIGNAL dout_im1                         : std_logic_vector(38 DOWNTO 0);  -- ufix39
  SIGNAL dout_vld1                        : std_logic;

BEGIN
  u_CTRL1_1_1 : RADIX22FFT_CTRL1_1_block9
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_SDF1_1_1 : RADIX22FFT_SDF1_1_block4
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_CTRL2_2_1 : RADIX22FFT_CTRL1_2_block4
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              dout_1_1_vld => dout_1_1_vld,
  ...
  u_SDF2_2_1 : RADIX22FFT_SDF2_2_block4
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              dout_1_1_re => dout_1_1_re,  -- sfix33_En28
  ...
  u_twdlROM_3_1 : TWDLROM_3_1_block4
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              dout_2_1_vld => dout_2_1_vld,
  ...
  u_CTRL1_3_1 : RADIX22FFT_CTRL1_3_block4
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_SDF1_3_1 : RADIX22FFT_SDF1_3_block4
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_CTRL2_4_1 : RADIX22FFT_CTRL1_4_block4
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              dout_3_1_vld => dout_3_1_vld,
  ...
  u_SDF2_4_1 : RADIX22FFT_SDF2_4_block4
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              dout_3_1_re => dout_3_1_re,  -- sfix35_En28
  ...
  u_twdlROM_5_1 : TWDLROM_5_1_block4
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              dout_4_1_vld => dout_4_1_vld,
  ...
  u_CTRL1_5_1 : RADIX22FFT_CTRL1_5_block4
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_SDF1_5_1 : RADIX22FFT_SDF1_5_block4
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_CTRL2_6_1 : RADIX22FFT_CTRL1_6_block4
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              dout_5_1_vld => dout_5_1_vld,
  ...
  u_SDF2_6_1 : RADIX22FFT_SDF2_6_block4
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              dout_5_1_re => dout_5_1_re,  -- sfix37_En28
  ...
  u_twdlROM_7 : TWDLROM_7_1_block4
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              dout_6_1_vld => dout_6_1_vld,
  ...
  u_CTRLRX2 : RADIX22FFT_CTRL1_1_block10
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_RADIX2 : RADIX22FFT_SDF1_7_block4
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              din_7_re_dly => std_logic_vector(din_7_re_dly),  -- sfix38_En28
              din_7_im_dly => std_logic_vector(din_7_im_dly),  -- sfix38_En28
              ...
              twdl_7_im => twdl_7_im,  -- sfix32_En30
              proc_7_enb => proc_7_enb,
              dout_7_re => dout_7_re,  -- sfix39_En28
              dout_7_im => dout_7_im,  -- sfix39_En28
              dout_7_vld => dout_7_vld,
              dinXTwdl_7_vld => dinXTwdl_7_vld
              );

  u_NaturalOrder_Stage : RADIX2FFT_bitNatural_block4
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              dout_7_re => dout_7_re,  -- sfix39_En28
              dout_7_im => dout_7_im,  -- sfix39_En28
              dout_7_vld => dout_7_vld,
              dout_re1 => dout_re1,  -- sfix39_En28
              dout_im1 => dout_im1,  -- sfix39_En28
              dout_vld1 => dout_vld1
              );
