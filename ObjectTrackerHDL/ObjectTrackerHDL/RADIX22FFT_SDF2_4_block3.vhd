-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\ObjectTrackerHDL\RADIX22FFT_SDF2_4_block3.vhd
...
-- Source Path: ObjectTrackerHDL/ObjectTrackerHDL/Track/2-DCorrelation/Prev2-DFFT/ColumnFFT/RADIX22FFT_SDF2_4
-- Hierarchy Level: 5
-- Model version: 3.7
-- 
-- -------------------------------------------------------------
...
ENTITY RADIX22FFT_SDF2_4_block3 IS
...
END RADIX22FFT_SDF2_4_block3;


ARCHITECTURE rtl OF RADIX22FFT_SDF2_4_block3 IS
  ...
  COMPONENT SDFCommutator4_block3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dout_3_1_vld                    :   IN    std_logic;
          xf_re                           :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En16
          xf_im                           :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En16
          xf_vld                          :   IN    std_logic;
          dinf_re                         :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En16
          dinf_im                         :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En16
          dinf_vld                        :   IN    std_logic;
          btf1_re                         :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En16
          btf1_im                         :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En16
          btf2_re                         :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En16
          btf2_im                         :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En16
          btfout_vld                      :   IN    std_logic;
          wrData_re                       :   OUT   std_logic_vector(31 DOWNTO 0);  -- sfix32_En16
          wrData_im                       :   OUT   std_logic_vector(31 DOWNTO 0);  -- sfix32_En16
  ...
  FOR ALL : SDFCommutator4_block3
    USE ENTITY work.SDFCommutator4_block3(rtl);

  -- Signals
  SIGNAL dout_3_1_re_signed               : signed(30 DOWNTO 0);  -- sfix31_En16
  SIGNAL din_re                           : signed(31 DOWNTO 0);  -- sfix32_En16
  SIGNAL dout_3_1_im_signed               : signed(30 DOWNTO 0);  -- sfix31_En16
  SIGNAL din_im                           : signed(31 DOWNTO 0);  -- sfix32_En16
  ...
  SIGNAL btf2_im                          : signed(31 DOWNTO 0);  -- sfix32_En16
  SIGNAL btf2_re                          : signed(31 DOWNTO 0);  -- sfix32_En16
  SIGNAL btf1_im                          : signed(31 DOWNTO 0);  -- sfix32_En16
  SIGNAL btf1_re                          : signed(31 DOWNTO 0);  -- sfix32_En16
  SIGNAL dinf_im                          : signed(31 DOWNTO 0);  -- sfix32_En16
  SIGNAL dinf_re                          : signed(31 DOWNTO 0);  -- sfix32_En16
  SIGNAL xf_im                            : signed(31 DOWNTO 0);  -- sfix32_En16
  SIGNAL wrData_im                        : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL wrAddr                           : std_logic_vector(2 DOWNTO 0);  -- ufix3
  SIGNAL wrEnb                            : std_logic;
  SIGNAL x_im                             : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL x_im_signed                      : signed(31 DOWNTO 0);  -- sfix32_En16
  SIGNAL x_im_dly                         : signed(31 DOWNTO 0);  -- sfix32_En16
  SIGNAL wrData_re                        : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL x_re                             : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL x_re_signed                      : signed(31 DOWNTO 0);  -- sfix32_En16
  SIGNAL x_re_dly                         : signed(31 DOWNTO 0);  -- sfix32_En16
  ...
  SIGNAL Radix22ButterflyG2_btf1_re_reg_next : signed(32 DOWNTO 0);  -- sfix33_En16
  SIGNAL Radix22ButterflyG2_btf1_im_reg_next : signed(32 DOWNTO 0);  -- sfix33_En16
  SIGNAL Radix22ButterflyG2_btf2_re_reg_next : signed(32 DOWNTO 0);  -- sfix33_En16
  SIGNAL Radix22ButterflyG2_btf2_im_reg_next : signed(32 DOWNTO 0);  -- sfix33_En16
  SIGNAL Radix22ButterflyG2_din_re_dly_next : signed(31 DOWNTO 0);  -- sfix32_En16
  SIGNAL Radix22ButterflyG2_din_im_dly_next : signed(31 DOWNTO 0);  -- sfix32_En16
  SIGNAL Radix22ButterflyG2_din_vld_dly_next : std_logic;
  SIGNAL Radix22ButterflyG2_x_re_dly_next : signed(31 DOWNTO 0);  -- sfix32_En16
  SIGNAL Radix22ButterflyG2_x_im_dly_next : signed(31 DOWNTO 0);  -- sfix32_En16
  SIGNAL Radix22ButterflyG2_x_vld_dly_next : std_logic;
  SIGNAL Radix22ButterflyG2_dinXTwdl_re_dly1_next : signed(31 DOWNTO 0);  -- sfix32_En16
  SIGNAL Radix22ButterflyG2_dinXTwdl_im_dly1_next : signed(31 DOWNTO 0);  -- sfix32_En16
  SIGNAL Radix22ButterflyG2_dinXTwdl_re_dly2_next : signed(31 DOWNTO 0);  -- sfix32_En16
  SIGNAL Radix22ButterflyG2_dinXTwdl_im_dly2_next : signed(31 DOWNTO 0);  -- sfix32_En16
  SIGNAL Radix22ButterflyG2_multiply_J_dly1_next : std_logic;
  SIGNAL xf_re                            : signed(31 DOWNTO 0);  -- sfix32_En16
  SIGNAL xf_vld                           : std_logic;
  SIGNAL dinf_vld                         : std_logic;
  SIGNAL btfout_vld                       : std_logic;
  SIGNAL dout_4_1_re_tmp                  : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL dout_4_1_im_tmp                  : std_logic_vector(31 DOWNTO 0);  -- ufix32

BEGIN
  u_dataMEM_im_0_4 : SimpleDualPortRAM_generic_block
  ...
  u_dataMEM_re_0_4 : SimpleDualPortRAM_generic_block
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 32
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_4 : SDFCommutator4_block3
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              dout_3_1_vld => dout_3_1_vld,
              xf_re => std_logic_vector(xf_re),  -- sfix32_En16
              xf_im => std_logic_vector(xf_im),  -- sfix32_En16
              xf_vld => xf_vld,
              dinf_re => std_logic_vector(dinf_re),  -- sfix32_En16
              dinf_im => std_logic_vector(dinf_im),  -- sfix32_En16
              dinf_vld => dinf_vld,
              btf1_re => std_logic_vector(btf1_re),  -- sfix32_En16
              btf1_im => std_logic_vector(btf1_im),  -- sfix32_En16
              btf2_re => std_logic_vector(btf2_re),  -- sfix32_En16
              btf2_im => std_logic_vector(btf2_im),  -- sfix32_En16
              btfout_vld => btfout_vld,
              wrData_re => wrData_re,  -- sfix32_En16
              wrData_im => wrData_im,  -- sfix32_En16
              wrAddr => wrAddr,  -- ufix3
              wrEnb => wrEnb,
              dout_4_1_re => dout_4_1_re_tmp,  -- sfix32_En16
              dout_4_1_im => dout_4_1_im_tmp,  -- sfix32_En16
              dout_4_1_vld => dout_4_1_vld
              );

  dout_3_1_re_signed <= signed(dout_3_1_re);

  din_re <= resize(dout_3_1_re_signed, 32);

  dout_3_1_im_signed <= signed(dout_3_1_im);

  din_im <= resize(dout_3_1_im_signed, 32);
