-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\ObjectTrackerHDL\SDFCommutator5_block3.vhd
...
-- Source Path: ObjectTrackerHDL/ObjectTrackerHDL/Track/2-DCorrelation/Prev2-DFFT/ColumnFFT/RADIX22FFT_SDF1_5/SDFCommutator5
-- Hierarchy Level: 6
-- Model version: 3.7
-- 
-- -------------------------------------------------------------
...
ENTITY SDFCommutator5_block3 IS
...
END SDFCommutator5_block3;


ARCHITECTURE rtl OF SDFCommutator5_block3 IS
  ...
  -- Signals
  SIGNAL xf_re_signed                     : signed(32 DOWNTO 0);  -- sfix33_En16
  SIGNAL xf_im_signed                     : signed(32 DOWNTO 0);  -- sfix33_En16
  SIGNAL dinXTwdlf_re_signed              : signed(32 DOWNTO 0);  -- sfix33_En16
  SIGNAL dinXTwdlf_im_signed              : signed(32 DOWNTO 0);  -- sfix33_En16
  SIGNAL btf1_re_signed                   : signed(32 DOWNTO 0);  -- sfix33_En16
  SIGNAL btf1_im_signed                   : signed(32 DOWNTO 0);  -- sfix33_En16
  SIGNAL btf2_re_signed                   : signed(32 DOWNTO 0);  -- sfix33_En16
  SIGNAL btf2_im_signed                   : signed(32 DOWNTO 0);  -- sfix33_En16
  ...
  SIGNAL SDFCummutator_out_re_next        : signed(32 DOWNTO 0);  -- sfix33_En16
  SIGNAL SDFCummutator_out_im_next        : signed(32 DOWNTO 0);  -- sfix33_En16
  ...
  SIGNAL SDFCummutator_wrData_re_reg_next : signed(32 DOWNTO 0);  -- sfix33_En16
  SIGNAL SDFCummutator_wrData_im_reg_next : signed(32 DOWNTO 0);  -- sfix33_En16
  SIGNAL SDFCummutator_wrEnb_reg_next     : std_logic;
  SIGNAL SDFCummutator_wrXData_re_reg_next : signed(32 DOWNTO 0);  -- sfix33_En16
  SIGNAL SDFCummutator_wrXData_im_reg_next : signed(32 DOWNTO 0);  -- sfix33_En16
  ...
  SIGNAL wrData_re_tmp                    : signed(32 DOWNTO 0);  -- sfix33_En16
  SIGNAL wrData_im_tmp                    : signed(32 DOWNTO 0);  -- sfix33_En16
  SIGNAL wrAddr_tmp                       : unsigned(1 DOWNTO 0);  -- ufix2
  SIGNAL xData_re                         : signed(32 DOWNTO 0);  -- sfix33_En16
  SIGNAL xData_im                         : signed(32 DOWNTO 0);  -- sfix33_En16
  ...
  SIGNAL dout0_re                         : signed(32 DOWNTO 0);  -- sfix33_En16
  SIGNAL dout0_im                         : signed(32 DOWNTO 0);  -- sfix33_En16
  SIGNAL dout0_vld                        : std_logic;
  SIGNAL xX_re                            : std_logic_vector(32 DOWNTO 0);  -- ufix33
  SIGNAL xX_re_signed                     : signed(32 DOWNTO 0);  -- sfix33_En16
  SIGNAL xX_im                            : std_logic_vector(32 DOWNTO 0);  -- ufix33
  SIGNAL xX_im_signed                     : signed(32 DOWNTO 0);  -- sfix33_En16
  ...
  SIGNAL SDFOutmux_btf2Pipe_re_next       : signed(32 DOWNTO 0);  -- sfix33_En16
  SIGNAL SDFOutmux_btf2Pipe_im_next       : signed(32 DOWNTO 0);  -- sfix33_En16
  SIGNAL SDFOutmux_btfPipe_vld_next       : std_logic;
  SIGNAL dout_5_1_re_tmp                  : signed(32 DOWNTO 0);  -- sfix33_En16
  SIGNAL dout_5_1_im_tmp                  : signed(32 DOWNTO 0);  -- sfix33_En16

BEGIN
  u_dataXMEM_re_0_5 : SimpleDualPortRAM_generic_block
  ...
  u_dataXMEM_im_0_5 : SimpleDualPortRAM_generic_block
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 33
                 )
    PORT MAP( clk => clk,
