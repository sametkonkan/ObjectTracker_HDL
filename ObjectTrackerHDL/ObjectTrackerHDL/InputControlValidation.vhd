-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\ObjectTrackerHDL\InputControlValidation.vhd
...
-- Source Path: ObjectTrackerHDL/ObjectTrackerHDL/Preprocess/Edge Detector/LineBuffer/InputControlValidation
-- Hierarchy Level: 4
-- Model version: 3.7
-- 
-- -------------------------------------------------------------
...
BEGIN
  ...
  inFPReg_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  inLPReg_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
