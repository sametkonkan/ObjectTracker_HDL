-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\ObjectTrackerHDL\RADIX22FFT_SDF1_3_block4.vhd
...
-- Source Path: ObjectTrackerHDL/ObjectTrackerHDL/Track/2-DCorrelation/Prev2-DFFT/RowFFT/RADIX22FFT_SDF1_3
-- Hierarchy Level: 5
-- Model version: 3.7
-- 
-- -------------------------------------------------------------
...
ENTITY RADIX22FFT_SDF1_3_block4 IS
...
END RADIX22FFT_SDF1_3_block4;


ARCHITECTURE rtl OF RADIX22FFT_SDF1_3_block4 IS
  ...
  COMPONENT SDFCommutator3_block4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          din_3_vld_dly                   :   IN    std_logic;
  ...
  FOR ALL : SDFCommutator3_block4
    USE ENTITY work.SDFCommutator3_block4(rtl);
...
BEGIN
  u_MUL4 : Complex4Multiply_block14
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_SDFCOMMUTATOR_3 : SDFCommutator3_block4
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              din_3_vld_dly => din_3_vld_dly,
