-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\ObjectTrackerHDL\RowFFT.vhd
...
-- 
-- Module: RowFFT
-- Source Path: ObjectTrackerHDL/ObjectTrackerHDL/Track/2-DCorrelation/Curr2-DFFT/RowFFT
-- Hierarchy Level: 4
-- Model version: 3.7
-- 
-- FFT
...
ARCHITECTURE rtl OF RowFFT IS

  -- Component Declarations
  COMPONENT RADIX22FFT_CTRL1_1_block5
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT RADIX22FFT_SDF1_1_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT RADIX22FFT_CTRL1_2_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT RADIX22FFT_SDF2_2_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT RADIX22FFT_CTRL1_3_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT RADIX22FFT_SDF1_3_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT RADIX22FFT_CTRL1_4_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT RADIX22FFT_SDF2_4_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT RADIX22FFT_CTRL1_5_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT RADIX22FFT_SDF1_5_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT RADIX22FFT_CTRL1_6_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT RADIX22FFT_SDF2_6_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT RADIX22FFT_CTRL1_1_block6
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT RADIX22FFT_SDF1_7_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT RADIX2FFT_bitNatural_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : RADIX22FFT_CTRL1_1_block5
    USE ENTITY work.RADIX22FFT_CTRL1_1_block5(rtl);

  FOR ALL : RADIX22FFT_SDF1_1_block2
    USE ENTITY work.RADIX22FFT_SDF1_1_block2(rtl);

  FOR ALL : RADIX22FFT_CTRL1_2_block2
    USE ENTITY work.RADIX22FFT_CTRL1_2_block2(rtl);

  FOR ALL : RADIX22FFT_SDF2_2_block2
    USE ENTITY work.RADIX22FFT_SDF2_2_block2(rtl);

  FOR ALL : TWDLROM_3_1_block2
    USE ENTITY work.TWDLROM_3_1_block2(rtl);

  FOR ALL : RADIX22FFT_CTRL1_3_block2
    USE ENTITY work.RADIX22FFT_CTRL1_3_block2(rtl);

  FOR ALL : RADIX22FFT_SDF1_3_block2
    USE ENTITY work.RADIX22FFT_SDF1_3_block2(rtl);

  FOR ALL : RADIX22FFT_CTRL1_4_block2
    USE ENTITY work.RADIX22FFT_CTRL1_4_block2(rtl);

  FOR ALL : RADIX22FFT_SDF2_4_block2
    USE ENTITY work.RADIX22FFT_SDF2_4_block2(rtl);

  FOR ALL : TWDLROM_5_1_block2
    USE ENTITY work.TWDLROM_5_1_block2(rtl);

  FOR ALL : RADIX22FFT_CTRL1_5_block2
    USE ENTITY work.RADIX22FFT_CTRL1_5_block2(rtl);

  FOR ALL : RADIX22FFT_SDF1_5_block2
    USE ENTITY work.RADIX22FFT_SDF1_5_block2(rtl);

  FOR ALL : RADIX22FFT_CTRL1_6_block2
    USE ENTITY work.RADIX22FFT_CTRL1_6_block2(rtl);

  FOR ALL : RADIX22FFT_SDF2_6_block2
    USE ENTITY work.RADIX22FFT_SDF2_6_block2(rtl);

  FOR ALL : TWDLROM_7_1_block2
    USE ENTITY work.TWDLROM_7_1_block2(rtl);

  FOR ALL : RADIX22FFT_CTRL1_1_block6
    USE ENTITY work.RADIX22FFT_CTRL1_1_block6(rtl);

  FOR ALL : RADIX22FFT_SDF1_7_block2
    USE ENTITY work.RADIX22FFT_SDF1_7_block2(rtl);

  FOR ALL : RADIX2FFT_bitNatural_block2
    USE ENTITY work.RADIX2FFT_bitNatural_block2(rtl);
...
BEGIN
  u_CTRL1_1_1 : RADIX22FFT_CTRL1_1_block5
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_SDF1_1_1 : RADIX22FFT_SDF1_1_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_CTRL2_2_1 : RADIX22FFT_CTRL1_2_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              dout_1_1_vld => dout_1_1_vld,
  ...
  u_SDF2_2_1 : RADIX22FFT_SDF2_2_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              dout_1_1_re => dout_1_1_re,  -- sfix33_En28
  ...
  u_twdlROM_3_1 : TWDLROM_3_1_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              dout_2_1_vld => dout_2_1_vld,
  ...
  u_CTRL1_3_1 : RADIX22FFT_CTRL1_3_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_SDF1_3_1 : RADIX22FFT_SDF1_3_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_CTRL2_4_1 : RADIX22FFT_CTRL1_4_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              dout_3_1_vld => dout_3_1_vld,
  ...
  u_SDF2_4_1 : RADIX22FFT_SDF2_4_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              dout_3_1_re => dout_3_1_re,  -- sfix35_En28
  ...
  u_twdlROM_5_1 : TWDLROM_5_1_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              dout_4_1_vld => dout_4_1_vld,
  ...
  u_CTRL1_5_1 : RADIX22FFT_CTRL1_5_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_SDF1_5_1 : RADIX22FFT_SDF1_5_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_CTRL2_6_1 : RADIX22FFT_CTRL1_6_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              dout_5_1_vld => dout_5_1_vld,
  ...
  u_SDF2_6_1 : RADIX22FFT_SDF2_6_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              dout_5_1_re => dout_5_1_re,  -- sfix37_En28
  ...
  u_twdlROM_7 : TWDLROM_7_1_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              dout_6_1_vld => dout_6_1_vld,
  ...
  u_CTRLRX2 : RADIX22FFT_CTRL1_1_block6
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_RADIX2 : RADIX22FFT_SDF1_7_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_NaturalOrder_Stage : RADIX2FFT_bitNatural_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              dout_7_re => dout_7_re,  -- sfix39_En28
