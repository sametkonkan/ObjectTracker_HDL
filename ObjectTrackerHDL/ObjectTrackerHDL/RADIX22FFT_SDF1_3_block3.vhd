-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\ObjectTrackerHDL\RADIX22FFT_SDF1_3_block3.vhd
...
-- Source Path: ObjectTrackerHDL/ObjectTrackerHDL/Track/2-DCorrelation/Prev2-DFFT/ColumnFFT/RADIX22FFT_SDF1_3
-- Hierarchy Level: 5
-- Model version: 3.7
-- 
-- -------------------------------------------------------------
...
ENTITY RADIX22FFT_SDF1_3_block3 IS
...
END RADIX22FFT_SDF1_3_block3;


ARCHITECTURE rtl OF RADIX22FFT_SDF1_3_block3 IS
  ...
  COMPONENT SDFCommutator3_block3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          din_3_vld_dly                   :   IN    std_logic;
          xf_re                           :   IN    std_logic_vector(30 DOWNTO 0);  -- sfix31_En16
          xf_im                           :   IN    std_logic_vector(30 DOWNTO 0);  -- sfix31_En16
          xf_vld                          :   IN    std_logic;
          dinXTwdlf_re                    :   IN    std_logic_vector(30 DOWNTO 0);  -- sfix31_En16
          dinXTwdlf_im                    :   IN    std_logic_vector(30 DOWNTO 0);  -- sfix31_En16
          dinxTwdlf_vld                   :   IN    std_logic;
          btf1_re                         :   IN    std_logic_vector(30 DOWNTO 0);  -- sfix31_En16
          btf1_im                         :   IN    std_logic_vector(30 DOWNTO 0);  -- sfix31_En16
          btf2_re                         :   IN    std_logic_vector(30 DOWNTO 0);  -- sfix31_En16
          btf2_im                         :   IN    std_logic_vector(30 DOWNTO 0);  -- sfix31_En16
          btf_vld                         :   IN    std_logic;
          wrData_re                       :   OUT   std_logic_vector(30 DOWNTO 0);  -- sfix31_En16
          wrData_im                       :   OUT   std_logic_vector(30 DOWNTO 0);  -- sfix31_En16
  ...
  FOR ALL : SDFCommutator3_block3
    USE ENTITY work.SDFCommutator3_block3(rtl);

  -- Signals
  SIGNAL din_3_1_re_dly_signed            : signed(29 DOWNTO 0);  -- sfix30_En16
  SIGNAL din_re                           : signed(30 DOWNTO 0);  -- sfix31_En16
  SIGNAL din_3_1_im_dly_signed            : signed(29 DOWNTO 0);  -- sfix30_En16
  SIGNAL din_im                           : signed(30 DOWNTO 0);  -- sfix31_En16
  ...
  SIGNAL dinXTwdl_re_signed               : signed(30 DOWNTO 0);  -- sfix31_En16
  SIGNAL dinXTwdl_im_signed               : signed(30 DOWNTO 0);  -- sfix31_En16
  SIGNAL x_vld                            : std_logic;
  SIGNAL btf2_im                          : signed(30 DOWNTO 0);  -- sfix31_En16
  SIGNAL btf2_re                          : signed(30 DOWNTO 0);  -- sfix31_En16
  SIGNAL btf1_im                          : signed(30 DOWNTO 0);  -- sfix31_En16
  SIGNAL btf1_re                          : signed(30 DOWNTO 0);  -- sfix31_En16
  SIGNAL dinXTwdlf_im                     : signed(30 DOWNTO 0);  -- sfix31_En16
  SIGNAL dinXTwdlf_re                     : signed(30 DOWNTO 0);  -- sfix31_En16
  SIGNAL xf_im                            : signed(30 DOWNTO 0);  -- sfix31_En16
  SIGNAL wrData_im                        : std_logic_vector(30 DOWNTO 0);  -- ufix31
  SIGNAL wrAddr                           : std_logic_vector(3 DOWNTO 0);  -- ufix4
  SIGNAL wrEnb                            : std_logic;
  SIGNAL x_im                             : std_logic_vector(30 DOWNTO 0);  -- ufix31
  SIGNAL x_im_signed                      : signed(30 DOWNTO 0);  -- sfix31_En16
  SIGNAL wrData_re                        : std_logic_vector(30 DOWNTO 0);  -- ufix31
  SIGNAL x_re                             : std_logic_vector(30 DOWNTO 0);  -- ufix31
  SIGNAL x_re_signed                      : signed(30 DOWNTO 0);  -- sfix31_En16
  ...
  SIGNAL Radix22ButterflyG1_btf1_re_reg_next : signed(31 DOWNTO 0);  -- sfix32_En16
  SIGNAL Radix22ButterflyG1_btf1_im_reg_next : signed(31 DOWNTO 0);  -- sfix32_En16
  SIGNAL Radix22ButterflyG1_btf2_re_reg_next : signed(31 DOWNTO 0);  -- sfix32_En16
  SIGNAL Radix22ButterflyG1_btf2_im_reg_next : signed(31 DOWNTO 0);  -- sfix32_En16
  SIGNAL Radix22ButterflyG1_add_cast      : signed(31 DOWNTO 0);  -- sfix32_En16
  SIGNAL Radix22ButterflyG1_add_cast_1    : signed(31 DOWNTO 0);  -- sfix32_En16
  SIGNAL Radix22ButterflyG1_sub_cast      : signed(31 DOWNTO 0);  -- sfix32_En16
  SIGNAL Radix22ButterflyG1_sub_cast_1    : signed(31 DOWNTO 0);  -- sfix32_En16
  SIGNAL Radix22ButterflyG1_add_cast_2    : signed(31 DOWNTO 0);  -- sfix32_En16
  SIGNAL Radix22ButterflyG1_add_cast_3    : signed(31 DOWNTO 0);  -- sfix32_En16
  SIGNAL Radix22ButterflyG1_sub_cast_2    : signed(31 DOWNTO 0);  -- sfix32_En16
  SIGNAL Radix22ButterflyG1_sub_cast_3    : signed(31 DOWNTO 0);  -- sfix32_En16
  SIGNAL xf_re                            : signed(30 DOWNTO 0);  -- sfix31_En16
  SIGNAL xf_vld                           : std_logic;
  SIGNAL dinxTwdlf_vld                    : std_logic;
  SIGNAL btf_vld                          : std_logic;
  SIGNAL dout_3_1_re_tmp                  : std_logic_vector(30 DOWNTO 0);  -- ufix31
  SIGNAL dout_3_1_im_tmp                  : std_logic_vector(30 DOWNTO 0);  -- ufix31
...
BEGIN
  u_MUL4 : Complex4Multiply_block11
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              din_re => std_logic_vector(din_re),  -- sfix31_En16
              din_im => std_logic_vector(din_im),  -- sfix31_En16
              din_3_vld_dly => din_3_vld_dly,
              twdl_3_1_re => twdl_3_1_re,  -- sfix28_En26
              twdl_3_1_im => twdl_3_1_im,  -- sfix28_En26
              dinXTwdl_re => dinXTwdl_re,  -- sfix31_En16
              dinXTwdl_im => dinXTwdl_im,  -- sfix31_En16
  ...
  u_SDFCOMMUTATOR_3 : SDFCommutator3_block3
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              din_3_vld_dly => din_3_vld_dly,
              xf_re => std_logic_vector(xf_re),  -- sfix31_En16
              xf_im => std_logic_vector(xf_im),  -- sfix31_En16
              xf_vld => xf_vld,
              dinXTwdlf_re => std_logic_vector(dinXTwdlf_re),  -- sfix31_En16
              dinXTwdlf_im => std_logic_vector(dinXTwdlf_im),  -- sfix31_En16
              dinxTwdlf_vld => dinxTwdlf_vld,
              btf1_re => std_logic_vector(btf1_re),  -- sfix31_En16
              btf1_im => std_logic_vector(btf1_im),  -- sfix31_En16
              btf2_re => std_logic_vector(btf2_re),  -- sfix31_En16
              btf2_im => std_logic_vector(btf2_im),  -- sfix31_En16
              btf_vld => btf_vld,
              wrData_re => wrData_re,  -- sfix31_En16
              wrData_im => wrData_im,  -- sfix31_En16
              wrAddr => wrAddr,  -- ufix4
              wrEnb => wrEnb,
              dout_3_1_re => dout_3_1_re_tmp,  -- sfix31_En16
              dout_3_1_im => dout_3_1_im_tmp,  -- sfix31_En16
              dout_3_1_vld => dout_3_1_vld
              );

  din_3_1_re_dly_signed <= signed(din_3_1_re_dly);

  din_re <= resize(din_3_1_re_dly_signed, 31);

  din_3_1_im_dly_signed <= signed(din_3_1_im_dly);

  din_im <= resize(din_3_1_im_dly_signed, 31);
