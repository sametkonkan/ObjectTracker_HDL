-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\ObjectTrackerHDL\RADIX22FFT_SDF2_2_block3.vhd
...
-- Source Path: ObjectTrackerHDL/ObjectTrackerHDL/Track/2-DCorrelation/Prev2-DFFT/ColumnFFT/RADIX22FFT_SDF2_2
-- Hierarchy Level: 5
-- Model version: 3.7
-- 
-- -------------------------------------------------------------
...
ARCHITECTURE rtl OF RADIX22FFT_SDF2_2_block3 IS
  ...
  COMPONENT SDFCommutator2_block3
    PORT( clk                             :   IN    std_logic;
          ...
          enb                             :   IN    std_logic;
          dout_1_1_vld                    :   IN    std_logic;
          xf_re                           :   IN    std_logic_vector(29 DOWNTO 0);  -- sfix30_En16
          xf_im                           :   IN    std_logic_vector(29 DOWNTO 0);  -- sfix30_En16
          xf_vld                          :   IN    std_logic;
          dinf_re                         :   IN    std_logic_vector(29 DOWNTO 0);  -- sfix30_En16
          dinf_im                         :   IN    std_logic_vector(29 DOWNTO 0);  -- sfix30_En16
          dinf_vld                        :   IN    std_logic;
          btf1_re                         :   IN    std_logic_vector(29 DOWNTO 0);  -- sfix30_En16
          btf1_im                         :   IN    std_logic_vector(29 DOWNTO 0);  -- sfix30_En16
          btf2_re                         :   IN    std_logic_vector(29 DOWNTO 0);  -- sfix30_En16
          btf2_im                         :   IN    std_logic_vector(29 DOWNTO 0);  -- sfix30_En16
          btfout_vld                      :   IN    std_logic;
          wrData_re                       :   OUT   std_logic_vector(29 DOWNTO 0);  -- sfix30_En16
          wrData_im                       :   OUT   std_logic_vector(29 DOWNTO 0);  -- sfix30_En16
  ...
  -- Signals
  SIGNAL dout_1_1_re_signed               : signed(28 DOWNTO 0);  -- sfix29_En16
  SIGNAL din_re                           : signed(29 DOWNTO 0);  -- sfix30_En16
  SIGNAL dout_1_1_im_signed               : signed(28 DOWNTO 0);  -- sfix29_En16
  SIGNAL din_im                           : signed(29 DOWNTO 0);  -- sfix30_En16
  ...
  SIGNAL btf2_im                          : signed(29 DOWNTO 0);  -- sfix30_En16
  SIGNAL btf2_re                          : signed(29 DOWNTO 0);  -- sfix30_En16
  SIGNAL btf1_im                          : signed(29 DOWNTO 0);  -- sfix30_En16
  SIGNAL btf1_re                          : signed(29 DOWNTO 0);  -- sfix30_En16
  SIGNAL dinf_im                          : signed(29 DOWNTO 0);  -- sfix30_En16
  SIGNAL dinf_re                          : signed(29 DOWNTO 0);  -- sfix30_En16
  SIGNAL xf_im                            : signed(29 DOWNTO 0);  -- sfix30_En16
  ...
  SIGNAL x_im_signed                      : signed(29 DOWNTO 0);  -- sfix30_En16
  SIGNAL x_im_dly                         : signed(29 DOWNTO 0);  -- sfix30_En16
  SIGNAL wrData_re                        : std_logic_vector(29 DOWNTO 0);  -- ufix30
  SIGNAL x_re                             : std_logic_vector(29 DOWNTO 0);  -- ufix30
  SIGNAL x_re_signed                      : signed(29 DOWNTO 0);  -- sfix30_En16
  SIGNAL x_re_dly                         : signed(29 DOWNTO 0);  -- sfix30_En16
  ...
  SIGNAL Radix22ButterflyG2_btf1_re_reg_next : signed(30 DOWNTO 0);  -- sfix31_En16
  SIGNAL Radix22ButterflyG2_btf1_im_reg_next : signed(30 DOWNTO 0);  -- sfix31_En16
  SIGNAL Radix22ButterflyG2_btf2_re_reg_next : signed(30 DOWNTO 0);  -- sfix31_En16
  SIGNAL Radix22ButterflyG2_btf2_im_reg_next : signed(30 DOWNTO 0);  -- sfix31_En16
  SIGNAL Radix22ButterflyG2_din_re_dly_next : signed(29 DOWNTO 0);  -- sfix30_En16
  SIGNAL Radix22ButterflyG2_din_im_dly_next : signed(29 DOWNTO 0);  -- sfix30_En16
  SIGNAL Radix22ButterflyG2_din_vld_dly_next : std_logic;
  SIGNAL Radix22ButterflyG2_x_re_dly_next : signed(29 DOWNTO 0);  -- sfix30_En16
  SIGNAL Radix22ButterflyG2_x_im_dly_next : signed(29 DOWNTO 0);  -- sfix30_En16
  SIGNAL Radix22ButterflyG2_x_vld_dly_next : std_logic;
  SIGNAL Radix22ButterflyG2_dinXTwdl_re_dly1_next : signed(29 DOWNTO 0);  -- sfix30_En16
  SIGNAL Radix22ButterflyG2_dinXTwdl_im_dly1_next : signed(29 DOWNTO 0);  -- sfix30_En16
  SIGNAL Radix22ButterflyG2_dinXTwdl_re_dly2_next : signed(29 DOWNTO 0);  -- sfix30_En16
  SIGNAL Radix22ButterflyG2_dinXTwdl_im_dly2_next : signed(29 DOWNTO 0);  -- sfix30_En16
  SIGNAL Radix22ButterflyG2_multiply_J_dly1_next : std_logic;
  SIGNAL xf_re                            : signed(29 DOWNTO 0);  -- sfix30_En16
  SIGNAL xf_vld                           : std_logic;
  SIGNAL dinf_vld                         : std_logic;
  SIGNAL btfout_vld                       : std_logic;
  SIGNAL dout_2_1_re_tmp                  : std_logic_vector(29 DOWNTO 0);  -- ufix30
  SIGNAL dout_2_1_im_tmp                  : std_logic_vector(29 DOWNTO 0);  -- ufix30

BEGIN
  u_dataMEM_im_0_2 : SimpleDualPortRAM_generic_block
  ...
  u_dataMEM_re_0_2 : SimpleDualPortRAM_generic_block
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 30
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_2 : SDFCommutator2_block3
    PORT MAP( clk => clk,
              ...
              xf_re => std_logic_vector(xf_re),  -- sfix30_En16
              xf_im => std_logic_vector(xf_im),  -- sfix30_En16
              xf_vld => xf_vld,
              dinf_re => std_logic_vector(dinf_re),  -- sfix30_En16
              dinf_im => std_logic_vector(dinf_im),  -- sfix30_En16
              dinf_vld => dinf_vld,
              btf1_re => std_logic_vector(btf1_re),  -- sfix30_En16
              btf1_im => std_logic_vector(btf1_im),  -- sfix30_En16
              btf2_re => std_logic_vector(btf2_re),  -- sfix30_En16
              btf2_im => std_logic_vector(btf2_im),  -- sfix30_En16
              btfout_vld => btfout_vld,
              wrData_re => wrData_re,  -- sfix30_En16
              wrData_im => wrData_im,  -- sfix30_En16
              wrAddr => wrAddr,  -- ufix5
              wrEnb => wrEnb,
              dout_2_1_re => dout_2_1_re_tmp,  -- sfix30_En16
              dout_2_1_im => dout_2_1_im_tmp,  -- sfix30_En16
              dout_2_1_vld => dout_2_1_vld
              );

  dout_1_1_re_signed <= signed(dout_1_1_re);

  din_re <= resize(dout_1_1_re_signed, 30);

  dout_1_1_im_signed <= signed(dout_1_1_im);

  din_im <= resize(dout_1_1_im_signed, 30);
