-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\ObjectTrackerHDL\RADIX22FFT_SDF1_7_block4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: RADIX22FFT_SDF1_7_block4
-- Source Path: ObjectTrackerHDL/ObjectTrackerHDL/Track/2-DCorrelation/Prev2-DFFT/RowFFT/RADIX22FFT_SDF1_7
-- Hierarchy Level: 5
-- Model version: 3.7
-- 
-- -------------------------------------------------------------
...
ENTITY RADIX22FFT_SDF1_7_block4 IS
...
END RADIX22FFT_SDF1_7_block4;


ARCHITECTURE rtl OF RADIX22FFT_SDF1_7_block4 IS
  ...
  COMPONENT SDFCommutator7_block4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          din_7_vld_dly                   :   IN    std_logic;
  ...
  FOR ALL : SDFCommutator7_block4
    USE ENTITY work.SDFCommutator7_block4(rtl);
...
BEGIN
  u_MUL4 : Complex4Multiply_block16
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_SDFCOMMUTATOR_7 : SDFCommutator7_block4
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              din_7_vld_dly => din_7_vld_dly,
