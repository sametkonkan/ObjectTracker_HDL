-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\ObjectTrackerHDL\Normalization_Var_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Normalization_Var_block
-- Source Path: ObjectTrackerHDL/ObjectTrackerHDL/Preprocess/PrevPreprocess/Image Statistics/calcMean/Normalization_Var
-- Hierarchy Level: 5
-- Model version: 3.7
-- 
...
ENTITY Normalization_Var_block IS
...
END Normalization_Var_block;


ARCHITECTURE rtl OF Normalization_Var_block IS

  -- Component Declarations
  COMPONENT Lookup_Table_block4
  ...
  FOR ALL : Lookup_Table_block4
    USE ENTITY work.Lookup_Table_block4(rtl);
  ...
  SIGNAL lvlOneAcc_unsigned               : unsigned(39 DOWNTO 0);  -- ufix40_En18
  SIGNAL lvlOneAccD                       : unsigned(39 DOWNTO 0);  -- ufix40_En18
  SIGNAL lvlOneAccIn                      : unsigned(39 DOWNTO 0);  -- ufix40_En18
  SIGNAL lvlTwoAcc_unsigned               : unsigned(39 DOWNTO 0);  -- ufix40_En18
  SIGNAL lvlThreeAcc_unsigned             : unsigned(39 DOWNTO 0);  -- ufix40_En18
  SIGNAL lvlFourAcc_unsigned              : unsigned(39 DOWNTO 0);  -- ufix40_En18
  SIGNAL accMUXout                        : unsigned(39 DOWNTO 0);  -- ufix40_En18
  SIGNAL intdelay_reg_1                   : vector_of_unsigned40(0 TO 1);  -- ufix40 [2]
  SIGNAL pipeAccMUXOut                    : unsigned(39 DOWNTO 0);  -- ufix40_En18
  SIGNAL multiplier_mul_temp              : unsigned(57 DOWNTO 0);  -- ufix58_En35
  SIGNAL recipMultOut                     : unsigned(39 DOWNTO 0);  -- ufix40_En24
  SIGNAL outputPipeline_reg               : vector_of_unsigned40(0 TO 1);  -- ufix40 [2]
  SIGNAL Normalized_tmp                   : unsigned(39 DOWNTO 0);  -- ufix40_En24

BEGIN
  -- [64x1] LUT of Reciprocal Values
  u_Lookup_Table : Lookup_Table_block4
  ...
  BEGIN
    IF reset = '1' THEN
      intdelay_reg_1 <= (OTHERS => to_unsigned(0, 40));
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  recipMultOut <= multiplier_mul_temp(50 DOWNTO 11);

  -- Pipeline Output of Normalization
  outputPipeline_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      outputPipeline_reg <= (OTHERS => to_unsigned(0, 40));
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
