-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\ObjectTrackerHDL\pixelBusGenerator.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: pixelBusGenerator
-- Source Path: ObjectTrackerHDL/ObjectTrackerHDL/Track/2-DCorrelation/2-DIFFT/pixelBusGenerator
-- Hierarchy Level: 4
-- Model version: 3.7
-- 
-- -------------------------------------------------------------
...
END pixelBusGenerator;


ARCHITECTURE rtl OF pixelBusGenerator IS

  -- Component Declarations
  COMPONENT Pixel_Control_Bus_Creator
  ...
  FOR ALL : Pixel_Control_Bus_Creator
    USE ENTITY work.Pixel_Control_Bus_Creator(rtl);
...
BEGIN
  u_Pixel_Control_Bus_Creator : Pixel_Control_Bus_Creator
