-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\ObjectTrackerHDL\Gamma_Corrector.vhd
...
-- Source Path: ObjectTrackerHDL/ObjectTrackerHDL/Preprocess/CurrPreprocess/Gamma Corrector
-- Hierarchy Level: 3
-- Model version: 3.7
-- 
-- Gamma Corrector
...
ARCHITECTURE rtl OF Gamma_Corrector IS
  ...
  FOR ALL : Lookup_Table
    USE ENTITY work.Lookup_Table(rtl);
