-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\ObjectTrackerHDL\RADIX2FFT_bitNatural_block4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: RADIX2FFT_bitNatural_block4
-- Source Path: ObjectTrackerHDL/ObjectTrackerHDL/Track/2-DCorrelation/Prev2-DFFT/RowFFT/RADIX2FFT_bitNatural
-- Hierarchy Level: 5
-- Model version: 3.7
-- 
-- -------------------------------------------------------------
...
ENTITY RADIX2FFT_bitNatural_block4 IS
...
END RADIX2FFT_bitNatural_block4;


ARCHITECTURE rtl OF RADIX2FFT_bitNatural_block4 IS
  ...
  SIGNAL memOut_im                        : std_logic_vector(38 DOWNTO 0);  -- ufix39
  SIGNAL memOut_im_signed                 : signed(38 DOWNTO 0);  -- sfix39_En28
  SIGNAL memOut_re                        : std_logic_vector(38 DOWNTO 0);  -- ufix39
  SIGNAL memOut_re_signed                 : signed(38 DOWNTO 0);  -- sfix39_En28
  ...
  SIGNAL rdStateMachineBitNatural_doutReReg : signed(38 DOWNTO 0);  -- sfix39
  SIGNAL rdStateMachineBitNatural_doutImReg : signed(38 DOWNTO 0);  -- sfix39
  ...
  SIGNAL rdStateMachineBitNatural_doutReReg_next : signed(38 DOWNTO 0);  -- sfix39_En28
  SIGNAL rdStateMachineBitNatural_doutImReg_next : signed(38 DOWNTO 0);  -- sfix39_En28
  ...
  SIGNAL dout_re1_tmp                     : signed(38 DOWNTO 0);  -- sfix39_En28
  SIGNAL dout_im1_tmp                     : signed(38 DOWNTO 0);  -- sfix39_En28
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      ...
      rdStateMachineBitNatural_doutReReg <= to_signed(0, 39);
      rdStateMachineBitNatural_doutImReg <= to_signed(0, 39);
