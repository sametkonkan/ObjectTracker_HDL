-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\ObjectTrackerHDL\RADIX22FFT_SDF1_7_block3.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: RADIX22FFT_SDF1_7_block3
-- Source Path: ObjectTrackerHDL/ObjectTrackerHDL/Track/2-DCorrelation/Prev2-DFFT/ColumnFFT/RADIX22FFT_SDF1_7
-- Hierarchy Level: 5
-- Model version: 3.7
-- 
-- -------------------------------------------------------------
...
ENTITY RADIX22FFT_SDF1_7_block3 IS
...
END RADIX22FFT_SDF1_7_block3;


ARCHITECTURE rtl OF RADIX22FFT_SDF1_7_block3 IS
  ...
  COMPONENT Complex4Multiply_block13
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          din_re                          :   IN    std_logic_vector(34 DOWNTO 0);  -- sfix35_En16
          din_im                          :   IN    std_logic_vector(34 DOWNTO 0);  -- sfix35_En16
          din_7_vld_dly                   :   IN    std_logic;
          twdl_7_re                       :   IN    std_logic_vector(27 DOWNTO 0);  -- sfix28_En26
          twdl_7_im                       :   IN    std_logic_vector(27 DOWNTO 0);  -- sfix28_En26
          dinXTwdl_re                     :   OUT   std_logic_vector(34 DOWNTO 0);  -- sfix35_En16
          dinXTwdl_im                     :   OUT   std_logic_vector(34 DOWNTO 0);  -- sfix35_En16
          dinXTwdl_7_vld                  :   OUT   std_logic
          );
  END COMPONENT;

  COMPONENT SDFCommutator7_block3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          din_7_vld_dly                   :   IN    std_logic;
          xf_re                           :   IN    std_logic_vector(34 DOWNTO 0);  -- sfix35_En16
          xf_im                           :   IN    std_logic_vector(34 DOWNTO 0);  -- sfix35_En16
          xf_vld                          :   IN    std_logic;
          dinXTwdlf_re                    :   IN    std_logic_vector(34 DOWNTO 0);  -- sfix35_En16
          dinXTwdlf_im                    :   IN    std_logic_vector(34 DOWNTO 0);  -- sfix35_En16
          dinxTwdlf_vld                   :   IN    std_logic;
          btf1_re                         :   IN    std_logic_vector(34 DOWNTO 0);  -- sfix35_En16
          btf1_im                         :   IN    std_logic_vector(34 DOWNTO 0);  -- sfix35_En16
          btf2_re                         :   IN    std_logic_vector(34 DOWNTO 0);  -- sfix35_En16
          btf2_im                         :   IN    std_logic_vector(34 DOWNTO 0);  -- sfix35_En16
          btf_vld                         :   IN    std_logic;
          wrData_re                       :   OUT   std_logic_vector(34 DOWNTO 0);  -- sfix35_En16
          wrData_im                       :   OUT   std_logic_vector(34 DOWNTO 0);  -- sfix35_En16
  ...
  FOR ALL : SDFCommutator7_block3
    USE ENTITY work.SDFCommutator7_block3(rtl);

  -- Signals
  SIGNAL din_7_re_dly_signed              : signed(33 DOWNTO 0);  -- sfix34_En16
  SIGNAL din_re                           : signed(34 DOWNTO 0);  -- sfix35_En16
  SIGNAL din_7_im_dly_signed              : signed(33 DOWNTO 0);  -- sfix34_En16
  SIGNAL din_im                           : signed(34 DOWNTO 0);  -- sfix35_En16
  ...
  SIGNAL dinXTwdl_re_signed               : signed(34 DOWNTO 0);  -- sfix35_En16
  SIGNAL dinXTwdl_im_signed               : signed(34 DOWNTO 0);  -- sfix35_En16
  SIGNAL x_vld                            : std_logic;
  SIGNAL btf2_im                          : signed(34 DOWNTO 0);  -- sfix35_En16
  SIGNAL btf2_re                          : signed(34 DOWNTO 0);  -- sfix35_En16
  SIGNAL btf1_im                          : signed(34 DOWNTO 0);  -- sfix35_En16
  SIGNAL btf1_re                          : signed(34 DOWNTO 0);  -- sfix35_En16
  SIGNAL dinXTwdlf_im                     : signed(34 DOWNTO 0);  -- sfix35_En16
  SIGNAL dinXTwdlf_re                     : signed(34 DOWNTO 0);  -- sfix35_En16
  SIGNAL xf_im                            : signed(34 DOWNTO 0);  -- sfix35_En16
  SIGNAL wrData_im                        : std_logic_vector(34 DOWNTO 0);  -- ufix35
  SIGNAL wrData_im_signed                 : signed(34 DOWNTO 0);  -- sfix35_En16
  SIGNAL wrData_re                        : std_logic_vector(34 DOWNTO 0);  -- ufix35
  SIGNAL wrData_re_signed                 : signed(34 DOWNTO 0);  -- sfix35_En16
  SIGNAL wrAddr                           : std_logic;  -- ufix1
  SIGNAL wrEnb                            : std_logic;
  SIGNAL twoLocationReg_0_MEM_re_0        : signed(34 DOWNTO 0);  -- sfix35
  SIGNAL twoLocationReg_0_MEM_im_0        : signed(34 DOWNTO 0);  -- sfix35
  SIGNAL twoLocationReg_0_MEM_re_1        : signed(34 DOWNTO 0);  -- sfix35
  SIGNAL twoLocationReg_0_MEM_im_1        : signed(34 DOWNTO 0);  -- sfix35
  SIGNAL twoLocationReg_0_dout_re_reg     : signed(34 DOWNTO 0);  -- sfix35
  SIGNAL twoLocationReg_0_dout_im_reg     : signed(34 DOWNTO 0);  -- sfix35
  SIGNAL twoLocationReg_0_MEM_re_0_next   : signed(34 DOWNTO 0);  -- sfix35_En16
  SIGNAL twoLocationReg_0_MEM_im_0_next   : signed(34 DOWNTO 0);  -- sfix35_En16
  SIGNAL twoLocationReg_0_MEM_re_1_next   : signed(34 DOWNTO 0);  -- sfix35_En16
  SIGNAL twoLocationReg_0_MEM_im_1_next   : signed(34 DOWNTO 0);  -- sfix35_En16
  SIGNAL twoLocationReg_0_dout_re_reg_next : signed(34 DOWNTO 0);  -- sfix35_En16
  SIGNAL twoLocationReg_0_dout_im_reg_next : signed(34 DOWNTO 0);  -- sfix35_En16
  SIGNAL x_re                             : signed(34 DOWNTO 0);  -- sfix35_En16
  SIGNAL x_im                             : signed(34 DOWNTO 0);  -- sfix35_En16
  ...
  SIGNAL Radix22ButterflyG1_btf1_re_reg_next : signed(35 DOWNTO 0);  -- sfix36_En16
  SIGNAL Radix22ButterflyG1_btf1_im_reg_next : signed(35 DOWNTO 0);  -- sfix36_En16
  SIGNAL Radix22ButterflyG1_btf2_re_reg_next : signed(35 DOWNTO 0);  -- sfix36_En16
  SIGNAL Radix22ButterflyG1_btf2_im_reg_next : signed(35 DOWNTO 0);  -- sfix36_En16
  SIGNAL Radix22ButterflyG1_add_cast      : signed(35 DOWNTO 0);  -- sfix36_En16
  SIGNAL Radix22ButterflyG1_add_cast_1    : signed(35 DOWNTO 0);  -- sfix36_En16
  SIGNAL Radix22ButterflyG1_sub_cast      : signed(35 DOWNTO 0);  -- sfix36_En16
  SIGNAL Radix22ButterflyG1_sub_cast_1    : signed(35 DOWNTO 0);  -- sfix36_En16
  SIGNAL Radix22ButterflyG1_add_cast_2    : signed(35 DOWNTO 0);  -- sfix36_En16
  SIGNAL Radix22ButterflyG1_add_cast_3    : signed(35 DOWNTO 0);  -- sfix36_En16
  SIGNAL Radix22ButterflyG1_sub_cast_2    : signed(35 DOWNTO 0);  -- sfix36_En16
  SIGNAL Radix22ButterflyG1_sub_cast_3    : signed(35 DOWNTO 0);  -- sfix36_En16
  SIGNAL xf_re                            : signed(34 DOWNTO 0);  -- sfix35_En16
  SIGNAL xf_vld                           : std_logic;
  SIGNAL dinxTwdlf_vld                    : std_logic;
  SIGNAL btf_vld                          : std_logic;
  SIGNAL dout_7_re_tmp                    : std_logic_vector(34 DOWNTO 0);  -- ufix35
  SIGNAL dout_7_im_tmp                    : std_logic_vector(34 DOWNTO 0);  -- ufix35
...
BEGIN
  u_MUL4 : Complex4Multiply_block13
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              din_re => std_logic_vector(din_re),  -- sfix35_En16
              din_im => std_logic_vector(din_im),  -- sfix35_En16
              din_7_vld_dly => din_7_vld_dly,
              twdl_7_re => twdl_7_re,  -- sfix28_En26
              twdl_7_im => twdl_7_im,  -- sfix28_En26
              dinXTwdl_re => dinXTwdl_re,  -- sfix35_En16
              dinXTwdl_im => dinXTwdl_im,  -- sfix35_En16
              dinXTwdl_7_vld => dinXTwdl_7_vld_1
              );

  u_SDFCOMMUTATOR_7 : SDFCommutator7_block3
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              din_7_vld_dly => din_7_vld_dly,
              xf_re => std_logic_vector(xf_re),  -- sfix35_En16
              xf_im => std_logic_vector(xf_im),  -- sfix35_En16
              xf_vld => xf_vld,
              dinXTwdlf_re => std_logic_vector(dinXTwdlf_re),  -- sfix35_En16
              dinXTwdlf_im => std_logic_vector(dinXTwdlf_im),  -- sfix35_En16
              dinxTwdlf_vld => dinxTwdlf_vld,
              btf1_re => std_logic_vector(btf1_re),  -- sfix35_En16
              btf1_im => std_logic_vector(btf1_im),  -- sfix35_En16
              btf2_re => std_logic_vector(btf2_re),  -- sfix35_En16
              btf2_im => std_logic_vector(btf2_im),  -- sfix35_En16
              btf_vld => btf_vld,
              wrData_re => wrData_re,  -- sfix35_En16
              wrData_im => wrData_im,  -- sfix35_En16
              wrAddr => wrAddr,  -- ufix1
              wrEnb => wrEnb,
              dout_7_re => dout_7_re_tmp,  -- sfix35_En16
              dout_7_im => dout_7_im_tmp,  -- sfix35_En16
              dout_7_vld => dout_7_vld
              );

  din_7_re_dly_signed <= signed(din_7_re_dly);

  din_re <= resize(din_7_re_dly_signed, 35);

  din_7_im_dly_signed <= signed(din_7_im_dly);

  din_im <= resize(din_7_im_dly_signed, 35);
  ...
  BEGIN
    IF reset = '1' THEN
      twoLocationReg_0_MEM_re_0 <= to_signed(0, 35);
      twoLocationReg_0_MEM_im_0 <= to_signed(0, 35);
      twoLocationReg_0_MEM_re_1 <= to_signed(0, 35);
      twoLocationReg_0_MEM_im_1 <= to_signed(0, 35);
      twoLocationReg_0_dout_re_reg <= to_signed(0, 35);
      twoLocationReg_0_dout_im_reg <= to_signed(0, 35);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  Radix22ButterflyG1_add_cast <= resize(x_re, 36);
  ...
  Radix22ButterflyG1_sub_cast <= resize(x_re, 36);
  ...
  Radix22ButterflyG1_add_cast_2 <= resize(x_im, 36);
  ...
  Radix22ButterflyG1_sub_cast_2 <= resize(x_im, 36);
