-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\ObjectTrackerHDL\RADIX22FFT_SDF1_5_block.vhd
...
-- Source Path: ObjectTrackerHDL/ObjectTrackerHDL/Track/2-DCorrelation/2-DIFFT/RowIFFT/RADIX22FFT_SDF1_5
-- Hierarchy Level: 5
-- Model version: 3.7
-- 
-- -------------------------------------------------------------
...
ARCHITECTURE rtl OF RADIX22FFT_SDF1_5_block IS
  ...
  SIGNAL dout_5_1_re_tmp                  : std_logic_vector(23 DOWNTO 0);  -- ufix24
  SIGNAL dout_5_1_im_tmp                  : std_logic_vector(23 DOWNTO 0);  -- ufix24
...
BEGIN
  u_MUL4 : Complex4Multiply_block3
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              din_5_1_re_dly => din_5_1_re_dly,  -- sfix24_En16
              din_5_1_im_dly => din_5_1_im_dly,  -- sfix24_En16
  ...
  u_SDFCOMMUTATOR_5 : SDFCommutator5_block
    PORT MAP( clk => clk,
              ...
              wrAddr => wrAddr,  -- ufix2
              wrEnb => wrEnb,
              dout_5_1_re => dout_5_1_re_tmp,  -- sfix24_En16
              dout_5_1_im => dout_5_1_im_tmp,  -- sfix24_En16
