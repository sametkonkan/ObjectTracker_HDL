-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\ObjectTrackerHDL\RADIX22FFT_SDF2_4_block.vhd
...
-- Source Path: ObjectTrackerHDL/ObjectTrackerHDL/Track/2-DCorrelation/2-DIFFT/RowIFFT/RADIX22FFT_SDF2_4
-- Hierarchy Level: 5
-- Model version: 3.7
-- 
-- -------------------------------------------------------------
...
ARCHITECTURE rtl OF RADIX22FFT_SDF2_4_block IS
  ...
  -- Signals
  SIGNAL dout_3_1_re_signed               : signed(23 DOWNTO 0);  -- sfix24_En16
  SIGNAL dout_3_1_im_signed               : signed(23 DOWNTO 0);  -- sfix24_En16
  ...
  SIGNAL dout_4_1_re_tmp                  : std_logic_vector(23 DOWNTO 0);  -- ufix24
  SIGNAL dout_4_1_im_tmp                  : std_logic_vector(23 DOWNTO 0);  -- ufix24
...
BEGIN
  ...
  u_SDFCOMMUTATOR_4 : SDFCommutator4_block
    PORT MAP( clk => clk,
              ...
              wrAddr => wrAddr,  -- ufix3
              wrEnb => wrEnb,
              dout_4_1_re => dout_4_1_re_tmp,  -- sfix24_En16
              dout_4_1_im => dout_4_1_im_tmp,  -- sfix24_En16
