-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\ObjectTrackerHDL\RowIFFT.vhd
...
-- 
-- Module: RowIFFT
-- Source Path: ObjectTrackerHDL/ObjectTrackerHDL/Track/2-DCorrelation/2-DIFFT/RowIFFT
-- Hierarchy Level: 4
-- Model version: 3.7
-- 
-- FFT
...
ARCHITECTURE rtl OF RowIFFT IS
  ...
  COMPONENT RADIX22FFT_CTRL1_1_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT RADIX2FFT_bitNatural_block
    PORT( clk                             :   IN    std_logic;
          ...
          dout_re1                        :   OUT   std_logic_vector(23 DOWNTO 0);  -- sfix24_En16
  ...
  FOR ALL : RADIX22FFT_CTRL1_1_block2
    USE ENTITY work.RADIX22FFT_CTRL1_1_block2(rtl);
...
BEGIN
  ...
  u_CTRLRX2 : RADIX22FFT_CTRL1_1_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_RADIX2 : RADIX22FFT_SDF1_7_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
