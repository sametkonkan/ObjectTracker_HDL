-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\ObjectTrackerHDL\ColumnFFT.vhd
...
-- 
-- Module: ColumnFFT
-- Source Path: ObjectTrackerHDL/ObjectTrackerHDL/Track/2-DCorrelation/Curr2-DFFT/ColumnFFT
-- Hierarchy Level: 4
-- Model version: 3.7
-- 
-- FFT
...
ARCHITECTURE rtl OF ColumnFFT IS

  -- Component Declarations
  COMPONENT RADIX22FFT_CTRL1_1_block3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT RADIX22FFT_CTRL1_1_block4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : RADIX22FFT_CTRL1_1_block3
    USE ENTITY work.RADIX22FFT_CTRL1_1_block3(rtl);
  ...
  FOR ALL : RADIX22FFT_CTRL1_1_block4
    USE ENTITY work.RADIX22FFT_CTRL1_1_block4(rtl);
...
BEGIN
  u_CTRL1_1_1 : RADIX22FFT_CTRL1_1_block3
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_twdlROM_7 : TWDLROM_7_1_block1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              dout_6_1_vld => dout_6_1_vld,
  ...
  u_CTRLRX2 : RADIX22FFT_CTRL1_1_block4
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_RADIX2 : RADIX22FFT_SDF1_7_block1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
