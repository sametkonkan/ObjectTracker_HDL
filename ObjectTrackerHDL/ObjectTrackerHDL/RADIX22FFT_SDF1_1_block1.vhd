-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\ObjectTrackerHDL\RADIX22FFT_SDF1_1_block1.vhd
...
-- Source Path: ObjectTrackerHDL/ObjectTrackerHDL/Track/2-DCorrelation/Curr2-DFFT/ColumnFFT/RADIX22FFT_SDF1_1
-- Hierarchy Level: 5
-- Model version: 3.7
-- 
-- -------------------------------------------------------------
...
ARCHITECTURE rtl OF RADIX22FFT_SDF1_1_block1 IS
  ...
  COMPONENT SDFCommutator1_block1
    PORT( clk                             :   IN    std_logic;
          ...
          enb                             :   IN    std_logic;
          din_1_vld_dly                   :   IN    std_logic;
          xf_re                           :   IN    std_logic_vector(28 DOWNTO 0);  -- sfix29_En16
          xf_im                           :   IN    std_logic_vector(28 DOWNTO 0);  -- sfix29_En16
          xf_vld                          :   IN    std_logic;
          dinXTwdlf_re                    :   IN    std_logic_vector(28 DOWNTO 0);  -- sfix29_En16
          dinXTwdlf_im                    :   IN    std_logic_vector(28 DOWNTO 0);  -- sfix29_En16
          dinxTwdlf_vld                   :   IN    std_logic;
          btf1_re                         :   IN    std_logic_vector(28 DOWNTO 0);  -- sfix29_En16
          btf1_im                         :   IN    std_logic_vector(28 DOWNTO 0);  -- sfix29_En16
          btf2_re                         :   IN    std_logic_vector(28 DOWNTO 0);  -- sfix29_En16
          btf2_im                         :   IN    std_logic_vector(28 DOWNTO 0);  -- sfix29_En16
          btf_vld                         :   IN    std_logic;
          wrData_re                       :   OUT   std_logic_vector(28 DOWNTO 0);  -- sfix29_En16
          wrData_im                       :   OUT   std_logic_vector(28 DOWNTO 0);  -- sfix29_En16
  ...
  -- Signals
  SIGNAL din_1_1_re_dly_signed            : signed(27 DOWNTO 0);  -- sfix28_En16
  SIGNAL din_re                           : signed(28 DOWNTO 0);  -- sfix29_En16
  SIGNAL dinXTwdl_re                      : signed(28 DOWNTO 0);  -- sfix29_En16
  SIGNAL din_1_1_im_dly_signed            : signed(27 DOWNTO 0);  -- sfix28_En16
  SIGNAL din_im                           : signed(28 DOWNTO 0);  -- sfix29_En16
  SIGNAL dinXTwdl_im                      : signed(28 DOWNTO 0);  -- sfix29_En16
  SIGNAL dinXTwdl_1_1_vld_1               : std_logic;
  SIGNAL x_vld                            : std_logic;
  SIGNAL btf2_im                          : signed(28 DOWNTO 0);  -- sfix29_En16
  SIGNAL btf2_re                          : signed(28 DOWNTO 0);  -- sfix29_En16
  SIGNAL btf1_im                          : signed(28 DOWNTO 0);  -- sfix29_En16
  SIGNAL btf1_re                          : signed(28 DOWNTO 0);  -- sfix29_En16
  SIGNAL dinXTwdlf_im                     : signed(28 DOWNTO 0);  -- sfix29_En16
  SIGNAL dinXTwdlf_re                     : signed(28 DOWNTO 0);  -- sfix29_En16
  SIGNAL xf_im                            : signed(28 DOWNTO 0);  -- sfix29_En16
  ...
  SIGNAL Radix22ButterflyG1_btf1_re_reg_next : signed(29 DOWNTO 0);  -- sfix30_En16
  SIGNAL Radix22ButterflyG1_btf1_im_reg_next : signed(29 DOWNTO 0);  -- sfix30_En16
  SIGNAL Radix22ButterflyG1_btf2_re_reg_next : signed(29 DOWNTO 0);  -- sfix30_En16
  SIGNAL Radix22ButterflyG1_btf2_im_reg_next : signed(29 DOWNTO 0);  -- sfix30_En16
  SIGNAL Radix22ButterflyG1_add_cast      : signed(29 DOWNTO 0);  -- sfix30_En16
  SIGNAL Radix22ButterflyG1_add_cast_1    : signed(29 DOWNTO 0);  -- sfix30_En16
  SIGNAL Radix22ButterflyG1_sub_cast      : signed(29 DOWNTO 0);  -- sfix30_En16
  SIGNAL Radix22ButterflyG1_sub_cast_1    : signed(29 DOWNTO 0);  -- sfix30_En16
  SIGNAL Radix22ButterflyG1_add_cast_2    : signed(29 DOWNTO 0);  -- sfix30_En16
  SIGNAL Radix22ButterflyG1_add_cast_3    : signed(29 DOWNTO 0);  -- sfix30_En16
  SIGNAL Radix22ButterflyG1_sub_cast_2    : signed(29 DOWNTO 0);  -- sfix30_En16
  SIGNAL Radix22ButterflyG1_sub_cast_3    : signed(29 DOWNTO 0);  -- sfix30_En16
  SIGNAL xf_re                            : signed(28 DOWNTO 0);  -- sfix29_En16
  SIGNAL xf_vld                           : std_logic;
  SIGNAL dinxTwdlf_vld                    : std_logic;
  SIGNAL btf_vld                          : std_logic;
  SIGNAL dout_1_1_re_tmp                  : std_logic_vector(28 DOWNTO 0);  -- ufix29
  SIGNAL dout_1_1_im_tmp                  : std_logic_vector(28 DOWNTO 0);  -- ufix29

BEGIN
  u_dataMEM_im_0_1 : SimpleDualPortRAM_generic_block
  ...
  u_dataMEM_re_0_1 : SimpleDualPortRAM_generic_block
    GENERIC MAP( AddrWidth => 6,
                 DataWidth => 29
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_1 : SDFCommutator1_block1
    PORT MAP( clk => clk,
              ...
              xf_re => std_logic_vector(xf_re),  -- sfix29_En16
              xf_im => std_logic_vector(xf_im),  -- sfix29_En16
              xf_vld => xf_vld,
              dinXTwdlf_re => std_logic_vector(dinXTwdlf_re),  -- sfix29_En16
              dinXTwdlf_im => std_logic_vector(dinXTwdlf_im),  -- sfix29_En16
              dinxTwdlf_vld => dinxTwdlf_vld,
              btf1_re => std_logic_vector(btf1_re),  -- sfix29_En16
              btf1_im => std_logic_vector(btf1_im),  -- sfix29_En16
              btf2_re => std_logic_vector(btf2_re),  -- sfix29_En16
              btf2_im => std_logic_vector(btf2_im),  -- sfix29_En16
              btf_vld => btf_vld,
              wrData_re => wrData_re,  -- sfix29_En16
              wrData_im => wrData_im,  -- sfix29_En16
              wrAddr => wrAddr,  -- ufix6
              wrEnb => wrEnb,
              dout_1_1_re => dout_1_1_re_tmp,  -- sfix29_En16
              dout_1_1_im => dout_1_1_im_tmp,  -- sfix29_En16
              dout_1_1_vld => dout_1_1_vld
              );

  din_1_1_re_dly_signed <= signed(din_1_1_re_dly);

  din_re <= resize(din_1_1_re_dly_signed, 29);

  intdelay_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      dinXTwdl_re <= to_signed(16#00000000#, 29);
  ...
  din_im <= resize(din_1_1_im_dly_signed, 29);

  intdelay_1_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      dinXTwdl_im <= to_signed(16#00000000#, 29);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        dinXTwdl_im <= din_im;
      END IF;
