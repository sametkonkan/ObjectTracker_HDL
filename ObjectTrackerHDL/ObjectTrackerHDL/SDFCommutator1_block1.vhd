-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\ObjectTrackerHDL\SDFCommutator1_block1.vhd
...
-- Source Path: ObjectTrackerHDL/ObjectTrackerHDL/Track/2-DCorrelation/Curr2-DFFT/ColumnFFT/RADIX22FFT_SDF1_1/SDFCommutator1
-- Hierarchy Level: 6
-- Model version: 3.7
-- 
-- -------------------------------------------------------------
...
ARCHITECTURE rtl OF SDFCommutator1_block1 IS
  ...
  -- Signals
  SIGNAL xf_re_signed                     : signed(28 DOWNTO 0);  -- sfix29_En16
  SIGNAL xf_im_signed                     : signed(28 DOWNTO 0);  -- sfix29_En16
  SIGNAL dinXTwdlf_re_signed              : signed(28 DOWNTO 0);  -- sfix29_En16
  SIGNAL dinXTwdlf_im_signed              : signed(28 DOWNTO 0);  -- sfix29_En16
  SIGNAL btf1_re_signed                   : signed(28 DOWNTO 0);  -- sfix29_En16
  SIGNAL btf1_im_signed                   : signed(28 DOWNTO 0);  -- sfix29_En16
  SIGNAL btf2_re_signed                   : signed(28 DOWNTO 0);  -- sfix29_En16
  SIGNAL btf2_im_signed                   : signed(28 DOWNTO 0);  -- sfix29_En16
  ...
  SIGNAL SDFCummutator_out_re_next        : signed(28 DOWNTO 0);  -- sfix29_En16
  SIGNAL SDFCummutator_out_im_next        : signed(28 DOWNTO 0);  -- sfix29_En16
  ...
  SIGNAL SDFCummutator_wrData_re_reg_next : signed(28 DOWNTO 0);  -- sfix29_En16
  SIGNAL SDFCummutator_wrData_im_reg_next : signed(28 DOWNTO 0);  -- sfix29_En16
  SIGNAL SDFCummutator_wrEnb_reg_next     : std_logic;
  SIGNAL SDFCummutator_wrXData_re_reg_next : signed(28 DOWNTO 0);  -- sfix29_En16
  SIGNAL SDFCummutator_wrXData_im_reg_next : signed(28 DOWNTO 0);  -- sfix29_En16
  ...
  SIGNAL wrData_re_tmp                    : signed(28 DOWNTO 0);  -- sfix29_En16
  SIGNAL wrData_im_tmp                    : signed(28 DOWNTO 0);  -- sfix29_En16
  SIGNAL wrAddr_tmp                       : unsigned(5 DOWNTO 0);  -- ufix6
  SIGNAL xData_re                         : signed(28 DOWNTO 0);  -- sfix29_En16
  SIGNAL xData_im                         : signed(28 DOWNTO 0);  -- sfix29_En16
  ...
  SIGNAL dout0_re                         : signed(28 DOWNTO 0);  -- sfix29_En16
  SIGNAL dout0_im                         : signed(28 DOWNTO 0);  -- sfix29_En16
  SIGNAL dout0_vld                        : std_logic;
  SIGNAL xX_re                            : std_logic_vector(28 DOWNTO 0);  -- ufix29
  SIGNAL xX_re_signed                     : signed(28 DOWNTO 0);  -- sfix29_En16
  SIGNAL xX_im                            : std_logic_vector(28 DOWNTO 0);  -- ufix29
  SIGNAL xX_im_signed                     : signed(28 DOWNTO 0);  -- sfix29_En16
  ...
  SIGNAL SDFOutmux_btf2Pipe_re_next       : signed(28 DOWNTO 0);  -- sfix29_En16
  SIGNAL SDFOutmux_btf2Pipe_im_next       : signed(28 DOWNTO 0);  -- sfix29_En16
  SIGNAL SDFOutmux_btfPipe_vld_next       : std_logic;
  SIGNAL dout_1_1_re_tmp                  : signed(28 DOWNTO 0);  -- sfix29_En16
  SIGNAL dout_1_1_im_tmp                  : signed(28 DOWNTO 0);  -- sfix29_En16
