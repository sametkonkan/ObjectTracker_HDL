-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\ObjectTrackerHDL\RADIX22FFT_SDF1_1_block.vhd
...
-- Source Path: ObjectTrackerHDL/ObjectTrackerHDL/Track/2-DCorrelation/2-DIFFT/RowIFFT/RADIX22FFT_SDF1_1
-- Hierarchy Level: 5
-- Model version: 3.7
-- 
-- -------------------------------------------------------------
...
ARCHITECTURE rtl OF RADIX22FFT_SDF1_1_block IS
  ...
  -- Signals
  SIGNAL din_1_1_re_dly_signed            : signed(23 DOWNTO 0);  -- sfix24_En16
  SIGNAL dinXTwdl_re                      : signed(23 DOWNTO 0);  -- sfix24_En16
  SIGNAL din_1_1_im_dly_signed            : signed(23 DOWNTO 0);  -- sfix24_En16
  SIGNAL dinXTwdl_im                      : signed(23 DOWNTO 0);  -- sfix24_En16
  ...
  SIGNAL dout_1_1_re_tmp                  : std_logic_vector(23 DOWNTO 0);  -- ufix24
  SIGNAL dout_1_1_im_tmp                  : std_logic_vector(23 DOWNTO 0);  -- ufix24
...
BEGIN
  ...
  u_SDFCOMMUTATOR_1 : SDFCommutator1_block
    PORT MAP( clk => clk,
              ...
              wrAddr => wrAddr,  -- ufix6
              wrEnb => wrEnb,
              dout_1_1_re => dout_1_1_re_tmp,  -- sfix24_En16
              dout_1_1_im => dout_1_1_im_tmp,  -- sfix24_En16
  ...
  BEGIN
    IF reset = '1' THEN
      dinXTwdl_re <= to_signed(16#000000#, 24);
  ...
  BEGIN
    IF reset = '1' THEN
      dinXTwdl_im <= to_signed(16#000000#, 24);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
