-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\ObjectTrackerHDL\CornerTurnMemory.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: CornerTurnMemory
-- Source Path: ObjectTrackerHDL/ObjectTrackerHDL/Track/2-DCorrelation/2-DIFFT/CornerTurnMemory
-- Hierarchy Level: 4
-- Model version: 3.7
-- 
-- -------------------------------------------------------------
...
END CornerTurnMemory;


ARCHITECTURE rtl OF CornerTurnMemory IS
  ...
  FOR ALL : CounterDelay
    USE ENTITY work.CounterDelay(rtl);

  FOR ALL : SwapAddr
    USE ENTITY work.SwapAddr(rtl);

  FOR ALL : BankBit
    USE ENTITY work.BankBit(rtl);

  FOR ALL : UpperRAM
    USE ENTITY work.UpperRAM(rtl);

  FOR ALL : LowerRAM
    USE ENTITY work.LowerRAM(rtl);
...
BEGIN
  ...
  Logical_Operator5_out1 <=  NOT BankBit_out1;

  enbWrUp <= Logical_Operator5_out1 AND validIn;
