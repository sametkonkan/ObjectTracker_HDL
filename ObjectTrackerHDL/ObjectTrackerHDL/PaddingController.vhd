-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\ObjectTrackerHDL\PaddingController.vhd
...
-- Source Path: ObjectTrackerHDL/ObjectTrackerHDL/Preprocess/Edge Detector/LineBuffer/PaddingController
-- Hierarchy Level: 4
-- Model version: 3.7
-- 
-- -------------------------------------------------------------
...
BEGIN
  -- Padding Controller
  PaddingController_1_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
