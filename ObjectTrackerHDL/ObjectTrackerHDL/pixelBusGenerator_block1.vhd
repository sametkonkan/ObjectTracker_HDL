-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\ObjectTrackerHDL\pixelBusGenerator_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: pixelBusGenerator_block1
-- Source Path: ObjectTrackerHDL/ObjectTrackerHDL/Track/2-DCorrelation/Prev2-DFFT/pixelBusGenerator
-- Hierarchy Level: 4
-- Model version: 3.7
-- 
-- -------------------------------------------------------------
...
ENTITY pixelBusGenerator_block1 IS
...
END pixelBusGenerator_block1;


ARCHITECTURE rtl OF pixelBusGenerator_block1 IS

  -- Component Declarations
  COMPONENT Pixel_Control_Bus_Creator_block1
  ...
  FOR ALL : Pixel_Control_Bus_Creator_block1
    USE ENTITY work.Pixel_Control_Bus_Creator_block1(rtl);
...
BEGIN
  u_Pixel_Control_Bus_Creator : Pixel_Control_Bus_Creator_block1
