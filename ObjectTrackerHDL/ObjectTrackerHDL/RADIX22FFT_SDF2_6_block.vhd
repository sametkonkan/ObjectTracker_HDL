-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\ObjectTrackerHDL\RADIX22FFT_SDF2_6_block.vhd
...
-- Source Path: ObjectTrackerHDL/ObjectTrackerHDL/Track/2-DCorrelation/2-DIFFT/RowIFFT/RADIX22FFT_SDF2_6
-- Hierarchy Level: 5
-- Model version: 3.7
-- 
-- -------------------------------------------------------------
...
ARCHITECTURE rtl OF RADIX22FFT_SDF2_6_block IS
  ...
  COMPONENT SDFCommutator6_block
    PORT( clk                             :   IN    std_logic;
          ...
          xf_vld                          :   IN    std_logic;
          dinf_re                         :   IN    std_logic_vector(23 DOWNTO 0);  -- sfix24_En16
          dinf_im                         :   IN    std_logic_vector(23 DOWNTO 0);  -- sfix24_En16
  ...
  -- Signals
  SIGNAL dout_5_1_re_signed               : signed(23 DOWNTO 0);  -- sfix24_En16
  SIGNAL dout_5_1_im_signed               : signed(23 DOWNTO 0);  -- sfix24_En16
  SIGNAL saveEnb                          : std_logic;
  SIGNAL dinVld                           : std_logic;
  SIGNAL din_re_dly1                      : signed(23 DOWNTO 0);  -- sfix24_En16
  SIGNAL btfin_re                         : signed(23 DOWNTO 0);  -- sfix24_En16
  SIGNAL din_im_dly1                      : signed(23 DOWNTO 0);  -- sfix24_En16
  SIGNAL btfin_im                         : signed(23 DOWNTO 0);  -- sfix24_En16
  ...
  SIGNAL dinf_im                          : signed(23 DOWNTO 0);  -- sfix24_En16
  SIGNAL dinf_re                          : signed(23 DOWNTO 0);  -- sfix24_En16
  SIGNAL xf_im                            : signed(23 DOWNTO 0);  -- sfix24_En16
  SIGNAL x_im                             : signed(23 DOWNTO 0);  -- sfix24_En16
  SIGNAL x_im_dly                         : signed(23 DOWNTO 0);  -- sfix24_En16
  SIGNAL wrData_im                        : std_logic_vector(23 DOWNTO 0);  -- ufix24
  SIGNAL wrData_im_signed                 : signed(23 DOWNTO 0);  -- sfix24_En16
  SIGNAL wrData_re                        : std_logic_vector(23 DOWNTO 0);  -- ufix24
  SIGNAL wrData_re_signed                 : signed(23 DOWNTO 0);  -- sfix24_En16
  ...
  SIGNAL twoLocationReg_0_MEM_re_0_next   : signed(23 DOWNTO 0);  -- sfix24_En16
  SIGNAL twoLocationReg_0_MEM_im_0_next   : signed(23 DOWNTO 0);  -- sfix24_En16
  SIGNAL twoLocationReg_0_MEM_re_1_next   : signed(23 DOWNTO 0);  -- sfix24_En16
  SIGNAL twoLocationReg_0_MEM_im_1_next   : signed(23 DOWNTO 0);  -- sfix24_En16
  SIGNAL twoLocationReg_0_dout_re_reg_next : signed(23 DOWNTO 0);  -- sfix24_En16
  SIGNAL twoLocationReg_0_dout_im_reg_next : signed(23 DOWNTO 0);  -- sfix24_En16
  SIGNAL x_re                             : signed(23 DOWNTO 0);  -- sfix24_En16
  SIGNAL x_re_dly                         : signed(23 DOWNTO 0);  -- sfix24_En16
  ...
  SIGNAL Radix22ButterflyG2_btf1_re_reg_next : signed(24 DOWNTO 0);  -- sfix25_En16
  SIGNAL Radix22ButterflyG2_btf1_im_reg_next : signed(24 DOWNTO 0);  -- sfix25_En16
  SIGNAL Radix22ButterflyG2_btf2_re_reg_next : signed(24 DOWNTO 0);  -- sfix25_En16
  SIGNAL Radix22ButterflyG2_btf2_im_reg_next : signed(24 DOWNTO 0);  -- sfix25_En16
  SIGNAL Radix22ButterflyG2_din_re_dly_next : signed(23 DOWNTO 0);  -- sfix24_En16
  SIGNAL Radix22ButterflyG2_din_im_dly_next : signed(23 DOWNTO 0);  -- sfix24_En16
  SIGNAL Radix22ButterflyG2_din_vld_dly_next : std_logic;
  SIGNAL Radix22ButterflyG2_x_re_dly_next : signed(23 DOWNTO 0);  -- sfix24_En16
  SIGNAL Radix22ButterflyG2_x_im_dly_next : signed(23 DOWNTO 0);  -- sfix24_En16
  SIGNAL Radix22ButterflyG2_x_vld_dly_next : std_logic;
  SIGNAL Radix22ButterflyG2_dinXTwdl_re_dly1_next : signed(23 DOWNTO 0);  -- sfix24_En16
  SIGNAL Radix22ButterflyG2_dinXTwdl_im_dly1_next : signed(23 DOWNTO 0);  -- sfix24_En16
  SIGNAL Radix22ButterflyG2_dinXTwdl_re_dly2_next : signed(23 DOWNTO 0);  -- sfix24_En16
  SIGNAL Radix22ButterflyG2_dinXTwdl_im_dly2_next : signed(23 DOWNTO 0);  -- sfix24_En16
  ...
  SIGNAL dout_6_1_re_tmp                  : std_logic_vector(23 DOWNTO 0);  -- ufix24
  SIGNAL dout_6_1_im_tmp                  : std_logic_vector(23 DOWNTO 0);  -- ufix24
...
BEGIN
  u_SDFCOMMUTATOR_6 : SDFCommutator6_block
    PORT MAP( clk => clk,
              ...
              xf_vld => xf_vld,
              dinf_re => std_logic_vector(dinf_re),  -- sfix24_En16
              dinf_im => std_logic_vector(dinf_im),  -- sfix24_En16
              dinf_vld => dinf_vld,
              ...
              wrAddr => wrAddr,  -- ufix1
              wrEnb => wrEnb,
              dout_6_1_re => dout_6_1_re_tmp,  -- sfix24_En16
              dout_6_1_im => dout_6_1_im_tmp,  -- sfix24_En16
  ...
  Radix22ButterflyG2_output : PROCESS (Radix22ButterflyG2_btf1_im_reg, Radix22ButterflyG2_btf1_re_reg,
    ...
    VARIABLE sra_temp : signed(24 DOWNTO 0);
    VARIABLE sra_temp_0 : signed(24 DOWNTO 0);
    VARIABLE sra_temp_1 : signed(24 DOWNTO 0);
    VARIABLE sra_temp_2 : signed(24 DOWNTO 0);
  BEGIN
