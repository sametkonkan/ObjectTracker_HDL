-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\ObjectTrackerHDL\RADIX22FFT_CTRL1_5_block3.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: RADIX22FFT_CTRL1_5_block3
-- Source Path: ObjectTrackerHDL/ObjectTrackerHDL/Track/2-DCorrelation/Prev2-DFFT/ColumnFFT/RADIX22FFT_CTRL1_5
-- Hierarchy Level: 5
-- Model version: 3.7
-- 
-- -------------------------------------------------------------
...
ENTITY RADIX22FFT_CTRL1_5_block3 IS
...
END RADIX22FFT_CTRL1_5_block3;


ARCHITECTURE rtl OF RADIX22FFT_CTRL1_5_block3 IS
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_5_Enb <= '0';
        IF dinXTwdl_5_1_vld = '1' AND (SDFController_wrCount = to_unsigned(16#3#, 2)) THEN 
