-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\ObjectTrackerHDL\RADIX22FFT_SDF2_4_block4.vhd
...
-- Source Path: ObjectTrackerHDL/ObjectTrackerHDL/Track/2-DCorrelation/Prev2-DFFT/RowFFT/RADIX22FFT_SDF2_4
-- Hierarchy Level: 5
-- Model version: 3.7
-- 
-- -------------------------------------------------------------
...
ENTITY RADIX22FFT_SDF2_4_block4 IS
...
END RADIX22FFT_SDF2_4_block4;


ARCHITECTURE rtl OF RADIX22FFT_SDF2_4_block4 IS
  ...
  COMPONENT SDFCommutator4_block4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dout_3_1_vld                    :   IN    std_logic;
  ...
  FOR ALL : SDFCommutator4_block4
    USE ENTITY work.SDFCommutator4_block4(rtl);
...
BEGIN
  ...
  u_SDFCOMMUTATOR_4 : SDFCommutator4_block4
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
