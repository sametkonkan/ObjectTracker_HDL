-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\ObjectTrackerHDL\Curr2_DFFT.vhd
...
-- 
-- Module: Curr2_DFFT
-- Source Path: ObjectTrackerHDL/ObjectTrackerHDL/Track/2-DCorrelation/Curr2-DFFT
-- Hierarchy Level: 3
-- Model version: 3.7
-- 
-- -------------------------------------------------------------
...
ARCHITECTURE rtl OF Curr2_DFFT IS
  ...
  COMPONENT CornerTurnMemory_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT pixelBusGenerator_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          validIn                         :   IN    std_logic;
  ...
  FOR ALL : RowFFT
    USE ENTITY work.RowFFT(rtl);

  FOR ALL : CornerTurnMemory_block
    USE ENTITY work.CornerTurnMemory_block(rtl);

  FOR ALL : ColumnFFT
    USE ENTITY work.ColumnFFT(rtl);

  FOR ALL : pixelBusGenerator_block
    USE ENTITY work.pixelBusGenerator_block(rtl);
...
BEGIN
  ...
  u_CornerTurnMemory : CornerTurnMemory_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_pixelBusGenerator : pixelBusGenerator_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
