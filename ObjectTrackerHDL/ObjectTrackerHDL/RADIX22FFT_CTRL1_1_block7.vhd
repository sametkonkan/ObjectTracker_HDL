-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\ObjectTrackerHDL\RADIX22FFT_CTRL1_1_block7.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: RADIX22FFT_CTRL1_1_block7
-- Source Path: ObjectTrackerHDL/ObjectTrackerHDL/Track/2-DCorrelation/Prev2-DFFT/ColumnFFT/RADIX22FFT_CTRL1_1
-- Hierarchy Level: 5
-- Model version: 3.7
-- 
-- -------------------------------------------------------------
...
ENTITY RADIX22FFT_CTRL1_1_block7 IS
...
END RADIX22FFT_CTRL1_1_block7;


ARCHITECTURE rtl OF RADIX22FFT_CTRL1_1_block7 IS
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_1_Enb <= '0';
        IF dinXTwdl_1_1_vld = '1' AND (SDFController_wrCount = to_unsigned(16#3F#, 6)) THEN 
