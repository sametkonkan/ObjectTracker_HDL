-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\ObjectTrackerHDL\Normalization_Var.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Normalization_Var
-- Source Path: ObjectTrackerHDL/ObjectTrackerHDL/Preprocess/CurrPreprocess/Image Statistics/calcMean/Normalization_Var
-- Hierarchy Level: 5
-- Model version: 3.7
-- 
...
END Normalization_Var;


ARCHITECTURE rtl OF Normalization_Var IS

  -- Component Declarations
  COMPONENT Lookup_Table_block1
  ...
  FOR ALL : Lookup_Table_block1
    USE ENTITY work.Lookup_Table_block1(rtl);
...
BEGIN
  ...
  u_Lookup_Table : Lookup_Table_block1
