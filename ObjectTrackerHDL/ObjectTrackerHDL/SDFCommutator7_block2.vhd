-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\ObjectTrackerHDL\SDFCommutator7_block2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SDFCommutator7_block2
-- Source Path: ObjectTrackerHDL/ObjectTrackerHDL/Track/2-DCorrelation/Curr2-DFFT/RowFFT/RADIX22FFT_SDF1_7/SDFCommutator7
-- Hierarchy Level: 6
-- Model version: 3.7
-- 
-- -------------------------------------------------------------
...
ENTITY SDFCommutator7_block2 IS
...
END SDFCommutator7_block2;


ARCHITECTURE rtl OF SDFCommutator7_block2 IS
  ...
  SIGNAL SDFCummutator_btf1_re_dly        : signed(38 DOWNTO 0);  -- sfix39
  SIGNAL SDFCummutator_btf1_im_dly        : signed(38 DOWNTO 0);  -- sfix39
  ...
  SIGNAL SDFCummutator_btf1_re_dly_next   : signed(38 DOWNTO 0);  -- sfix39_En28
  SIGNAL SDFCummutator_btf1_im_dly_next   : signed(38 DOWNTO 0);  -- sfix39_En28
  ...
  SIGNAL dout_7_re_tmp                    : signed(38 DOWNTO 0);  -- sfix39_En28
  SIGNAL dout_7_im_tmp                    : signed(38 DOWNTO 0);  -- sfix39_En28
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      ...
      SDFCummutator_btf1_re_dly <= to_signed(0, 39);
      SDFCummutator_btf1_im_dly <= to_signed(0, 39);
