-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\ObjectTrackerHDL\LineBuffer.vhd
...
-- 
-- Module: LineBuffer
-- Source Path: ObjectTrackerHDL/ObjectTrackerHDL/Preprocess/Edge Detector/LineBuffer
-- Hierarchy Level: 3
-- Model version: 3.7
-- 
-- -------------------------------------------------------------
...
ARCHITECTURE rtl OF LineBuffer IS
  ...
  SIGNAL intdelay_reg_4                   : std_logic_vector(2 DOWNTO 0);  -- ufix1 [3]
  ...
  SIGNAL intdelay_reg_5                   : std_logic_vector(1 DOWNTO 0);  -- ufix1 [2]
  ...
  SIGNAL intdelay_reg_7                   : std_logic_vector(1 DOWNTO 0);  -- ufix1 [2]
  ...
  SIGNAL intdelay_reg_8                   : std_logic_vector(1 DOWNTO 0);  -- ufix1 [2]
  ...
  SIGNAL intdelay_reg_9                   : std_logic_vector(1 DOWNTO 0);  -- ufix1 [2]
  ...
  SIGNAL intdelay_reg_10                  : std_logic_vector(2 DOWNTO 0);  -- ufix1 [3]
  ...
  SIGNAL intdelay_reg_11                  : std_logic_vector(3 DOWNTO 0);  -- ufix1 [4]
  SIGNAL vEndRD                           : std_logic;
  SIGNAL vEndRDH                          : std_logic;
  SIGNAL vEndP                            : std_logic;
  SIGNAL validFGG                         : std_logic;
  SIGNAL intdelay_reg_12                  : std_logic_vector(1 DOWNTO 0);  -- ufix1 [2]
...
BEGIN
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        ...
        intdelay_reg_4(2 DOWNTO 1) <= intdelay_reg_4(1 DOWNTO 0);
      END IF;
    END IF;
  ...
  --  initial value   = 0
  --  step value      = 1
  Blank_Count_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  constZero <= (OTHERS => to_unsigned(16#00#, 8));
  ...
  --  initial value   = 0
  --  step value      = 1
  Horizontal_Pad_Counter_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        ...
        intdelay_reg_10(2 DOWNTO 1) <= intdelay_reg_10(1 DOWNTO 0);
      END IF;
    END IF;
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        ...
        intdelay_reg_11(3 DOWNTO 1) <= intdelay_reg_11(2 DOWNTO 0);
      END IF;
    END IF;
  ...
  reg_23_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      validOD <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
  ...
  reg_24_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      processDataOD <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
