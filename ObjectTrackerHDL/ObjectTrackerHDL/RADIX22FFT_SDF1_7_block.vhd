-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\ObjectTrackerHDL\RADIX22FFT_SDF1_7_block.vhd
...
-- Source Path: ObjectTrackerHDL/ObjectTrackerHDL/Track/2-DCorrelation/2-DIFFT/RowIFFT/RADIX22FFT_SDF1_7
-- Hierarchy Level: 5
-- Model version: 3.7
-- 
-- -------------------------------------------------------------
...
ARCHITECTURE rtl OF RADIX22FFT_SDF1_7_block IS
  ...
  SIGNAL dout_7_re_tmp                    : std_logic_vector(23 DOWNTO 0);  -- ufix24
  SIGNAL dout_7_im_tmp                    : std_logic_vector(23 DOWNTO 0);  -- ufix24
...
BEGIN
  u_MUL4 : Complex4Multiply_block4
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              din_7_re_dly => din_7_re_dly,  -- sfix24_En16
              din_7_im_dly => din_7_im_dly,  -- sfix24_En16
  ...
  u_SDFCOMMUTATOR_7 : SDFCommutator7_block
    PORT MAP( clk => clk,
              ...
              wrAddr => wrAddr,  -- ufix1
              wrEnb => wrEnb,
              dout_7_re => dout_7_re_tmp,  -- sfix24_En16
              dout_7_im => dout_7_im_tmp,  -- sfix24_En16
  ...
  Radix22ButterflyG1_add_cast <= resize(x_re, 25);
  ...
  Radix22ButterflyG1_sub_cast <= resize(x_re, 25);
  ...
  Radix22ButterflyG1_add_cast_2 <= resize(x_im, 25);
  ...
  Radix22ButterflyG1_sub_cast_2 <= resize(x_im, 25);
