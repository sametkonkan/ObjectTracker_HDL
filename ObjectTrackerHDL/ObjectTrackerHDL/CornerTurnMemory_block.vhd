-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\ObjectTrackerHDL\CornerTurnMemory_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: CornerTurnMemory_block
-- Source Path: ObjectTrackerHDL/ObjectTrackerHDL/Track/2-DCorrelation/Curr2-DFFT/CornerTurnMemory
-- Hierarchy Level: 4
-- Model version: 3.7
-- 
-- -------------------------------------------------------------
...
ENTITY CornerTurnMemory_block IS
...
END CornerTurnMemory_block;


ARCHITECTURE rtl OF CornerTurnMemory_block IS

  -- Component Declarations
  COMPONENT CounterDelay_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          vld_in                          :   IN    std_logic;
  ...
  COMPONENT BankBit_block
    PORT( addrIn                          :   IN    std_logic_vector(14 DOWNTO 0);  -- ufix15
          bankWr                          :   OUT   std_logic
          );
  END COMPONENT;

  COMPONENT UpperRAM_block
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : CounterDelay_block
    USE ENTITY work.CounterDelay_block(rtl);

  FOR ALL : SwapAddr_block
    USE ENTITY work.SwapAddr_block(rtl);

  FOR ALL : BankBit_block
    USE ENTITY work.BankBit_block(rtl);

  FOR ALL : UpperRAM_block
    USE ENTITY work.UpperRAM_block(rtl);

  FOR ALL : LowerRAM_block
    USE ENTITY work.LowerRAM_block(rtl);
...
BEGIN
  u_CounterDelay : CounterDelay_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              vld_in => validIn,
