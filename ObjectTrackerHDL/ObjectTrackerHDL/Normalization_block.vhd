-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\ObjectTrackerHDL\Normalization_block.vhd
...
-- Source Path: ObjectTrackerHDL/ObjectTrackerHDL/Preprocess/PrevPreprocess/Image Statistics/calcMean/Normalization
-- Hierarchy Level: 5
-- Model version: 3.7
-- 
...
END Normalization_block;


ARCHITECTURE rtl OF Normalization_block IS

  -- Component Declarations
  COMPONENT Lookup_Table_block3
  ...
  FOR ALL : Lookup_Table_block3
    USE ENTITY work.Lookup_Table_block3(rtl);
...
BEGIN
  ...
  u_Lookup_Table : Lookup_Table_block3
